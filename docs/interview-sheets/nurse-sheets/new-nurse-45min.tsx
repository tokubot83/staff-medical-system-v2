                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <RadioGroup className="grid grid-cols-5 gap-3 mt-3">
                      <div className="flex flex-col items-center">
                        ...
                        <Label htmlFor="adapt-5" className="mt-1 text-sm">非常に良い</Label>
                      </div>
                      <div className="flex flex-col items-center">
                        <RadioGroupItem value="4" id="adapt-4" />
                        <Label htmlFor="adapt-4" className="mt-1 text-sm">良い</Label>
                      </div>
                      <div className="flex flex-col items-center">
                        <RadioGroupItem value="3" id="adapt-3" />
                        <Label htmlFor="adapt-3" className="mt-1 text-sm">普通</Label>
                      </div>
                      <div className="flex flex-col items-center">
                        <RadioGroupItem value="2" id="adapt-2" />
                        <Label htmlFor="adapt-2" className="mt-1 text-sm">やや困難</Label>
                      </div>
                      <div className="flex flex-col items-center">
                        <RadioGroupItem value="1" id="adapt-1" />
                        <Label htmlFor="adapt-1" className="mt-1 text-sm">困難</Label>
                      </div>
                    </RadioGroup>
                    <div className="mt-3">
