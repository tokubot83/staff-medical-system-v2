...
export default function ChronicJuniorAssistantNurseEvaluationV3() {
  return (
    <div className="container mx-auto py-10 px-4 max-w-5xl">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            【慢性期医療】2・3年目准看護師 人事評価シート
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            慢性期ケアの深化と後輩支援を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              2・3年目准看護師は慢性期ケア実践能力の向上と後輩支援への関わりを評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="facility" className="space-y-6 mt-6">
              ...
              <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="role-s" className="font-normal">
                          <span className="font-semibold">S：</span> 療養チームの重要な戦力として、病棟運営に貢献
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="a" id="role-a" />
                        <Label htmlFor="role-a" className="font-normal">
                          <span className="font-semibold">A：</span> 期待以上の役割を果たし、積極的に貢献
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="role-c" className="font-normal">
                          <span className="font-semibold">C：</span> 役割遂行に時々支援が必要
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="improve-s" className="font-normal">
                          <span className="font-semibold">S：</span> 主体的に療養環境改善を提案し、実行する
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="a" id="improve-a" />
                        <Label htmlFor="improve-a" className="font-normal">
                          <span className="font-semibold">A：</span> 積極的に改善活動に参加し、成果を上げる
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <Textarea 
                    id="facility-comment" 
                    placeholder="病棟での役割遂行、後輩支援の具体例、療養環境改善提案など"
            ...
            <TabsContent value="corporate" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  慢性期准看護実践能力の深化と専門性を中心に評価
                </p>
              </div>

              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold mb-3">1. 慢性期准看護実践能力の向上</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="practice-s" />
                        <Label htmlFor="practice-s" className="font-normal">
                          <span className="font-semibold">S：</span> 高度な慢性期ケアを実践し、複雑な状況にも対応
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="優れた慢性期ケア実践例、認知症ケアの工夫、生活支援の成果など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-6 mb-6">
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">チーム貢献・後輩支援</p>
                  </div>
                  <div className="bg-green-50 p-4 rounded-lg">
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="2・3年目准看護師としての慢性期ケア成長度、強み、今後の可能性など"
            ...
            <TabsContent value="development" className="space-y-6 mt-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea 
                    id="next-goals" 
                    placeholder="認知症ケア専門性向上、レクリエーション企画力、後輩支援力向上など"
                    className="min-h-[100px]"
                  />
                </div>
