...
export default function VeteranNursingAideEvaluationV3() {
  return (
    <div className="container mx-auto py-10 px-4 max-w-5xl">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            ベテラン看護補助者（11年目以上） 人事評価シート
          </CardTitle>
        ...
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ベテラン看護補助者は組織への影響力と知識・技術の継承を評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  ...
                  <div>
                    ...
                    <Input type="text" id="special-roles" placeholder="例：教育委員、環境整備責任者" />
                  </div>
                </div>
              </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="culture-s" className="font-normal">
                          <span className="font-semibold">S：</span> 補助者チームの精神的支柱として組織文化を形成
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
            ...
            <TabsContent value="corporate" className="space-y-6 mt-6">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold mb-3">1. 卓越した補助業務実践</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="mastery-s" />
                        <Label htmlFor="mastery-s" className="font-normal">
                          <span className="font-semibold">S：</span> 補助業務の最高峰として法人内外で認められる
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="卓越した実践例、サービス文化への貢献、法人発展への寄与など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-6 mb-6">
                  ...
                  <div className="bg-green-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">卓越した実践・法人貢献</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="ベテラン看護補助者としての総合評価、組織への貢献、今後の活躍など"
            ...
            <TabsContent value="development" className="space-y-6 mt-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Textarea 
                    id="strengths" 
                    placeholder="豊富な経験、専門知識、人間関係、組織への影響力など"
                ...
                <div>
                  ...
                  <Textarea 
                    id="special-mission" 
                    placeholder="補助者教育の体系化、環境整備マニュアルの作成、新人育成プログラムの開発など"
                    className="min-h-[100px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="succession-plan" 
                    placeholder="実技指導、勉強会講師、メンタリング活動など"
                    className="min-h-[100px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="専門アドバイザー、教育専任、リーダー職への転換など"
                    className="min-h-[80px]"
                  />
                </div>
