...
export default function MidlevelAssistantNurseEvaluationV3() {
  return (
    <div className="container mx-auto py-10 px-4 max-w-5xl">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            中堅准看護師（4-10年目） 人事評価シート
          </CardTitle>
        ...
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              中堅准看護師はリーダーシップの発揮と専門性の深化を評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  ...
                  <div>
                    ...
                    <Input type="text" id="roles" placeholder="例：チームリーダー、教育担当" />
                  </div>
                </div>
              </div>
            ...
            <TabsContent value="facility" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  リーダーシップと病棟運営への貢献を中心に評価
                </p>
              </div>

              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold mb-3">1. リーダーシップの発揮</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="leadership-s" />
                        <Label htmlFor="leadership-s" className="font-normal">
                          <span className="font-semibold">S：</span> 卓越したリーダーシップで病棟を牽引し、変革を推進
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  <h4 className="font-semibold mb-3">2. 人材育成への貢献</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  <h4 className="font-semibold mb-3">3. 病棟運営・マネジメント</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
            ...
            <TabsContent value="corporate" className="space-y-6 mt-6">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold mb-3">1. 専門的実践能力</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="expertise-s" />
                        <Label htmlFor="expertise-s" className="font-normal">
                          <span className="font-semibold">S：</span> 准看護師として最高レベルの実践能力を持ち、模範となる
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  <h4 className="font-semibold mb-3">2. 多職種連携・調整力</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="coordination-s" />
                        <Label htmlFor="coordination-s" className="font-normal">
                          <span className="font-semibold">S：</span> 多職種チームの中心となり、効果的な連携を実現
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="a" id="coordination-a" />
                        <Label htmlFor="coordination-a" className="font-normal">
                          <span className="font-semibold">A：</span> 積極的に多職種と連携し、良好な関係を構築
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="b" id="coordination-b" />
                        <Label htmlFor="coordination-b" className="font-normal">
                          <span className="font-semibold">B：</span> 必要な連携・調整を適切に行う
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="c" id="coordination-c" />
                        <Label htmlFor="coordination-c" className="font-normal">
                          <span className="font-semibold">C：</span> 連携・調整に消極的
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="d" id="coordination-d" />
                        <Label htmlFor="coordination-d" className="font-normal">
                          <span className="font-semibold">D：</span> 連携・調整力に課題があり、チーム医療に支障
                        </Label>
                      </div>
                    </div>
                  </RadioGroup>
                ...
                <div>
                  <h4 className="font-semibold mb-3">3. 法人への貢献・影響力</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="contribution-s" />
                        <Label htmlFor="contribution-s" className="font-normal">
                          <span className="font-semibold">S：</span> 法人レベルの活動に参画し、准看護師の代表として貢献
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="専門的実践の具体例、多職種連携の成果、法人への貢献など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="中堅准看護師としての総合評価、強み、今後の方向性など"
            ...
            <TabsContent value="development" className="space-y-6 mt-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Textarea 
                    id="strengths" 
                    placeholder="リーダーシップ、専門性、人材育成力など"
                ...
                <div>
                  ...
                  <Textarea 
                    id="growth-areas" 
                    placeholder="管理能力、専門性の更なる深化、組織への影響力など"
                    className="min-h-[80px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="next-goals" 
                    placeholder="管理職への挑戦、専門分野のリーダー、教育体制の構築など"
                    className="min-h-[100px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="support-plan" 
                    placeholder="管理者研修、専門資格取得支援、外部研修など"
                    className="min-h-[100px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="career-vision" 
                    placeholder="主任職への登用、専門分野のエキスパート、教育責任者など"
                    className="min-h-[80px]"
                  />
                </div>
