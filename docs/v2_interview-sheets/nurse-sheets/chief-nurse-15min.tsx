              ...
              <div className="bg-gray-50 p-4 rounded-lg space-y-3">
                ...
                <RadioGroup>
                  <div className="grid grid-cols-6 gap-2 items-center">
                    <span className="text-sm font-medium">管理業務の負担度</span>
                    <div className="flex justify-center">
                      <RadioGroupItem value="burden-5" id="burden-5" className="w-4 h-4" />
                    </div>
                    <div className="flex justify-center">
                      <RadioGroupItem value="burden-4" id="burden-4" className="w-4 h-4" />
                    </div>
                    <div className="flex justify-center">
                      <RadioGroupItem value="burden-3" id="burden-3" className="w-4 h-4" />
                    </div>
                    <div className="flex justify-center">
                      <RadioGroupItem value="burden-2" id="burden-2" className="w-4 h-4" />
                    </div>
                    <div className="flex justify-center">
                      <RadioGroupItem value="burden-1" id="burden-1" className="w-4 h-4" />
                    </div>
                  </div>
                </RadioGroup>
              </div>
