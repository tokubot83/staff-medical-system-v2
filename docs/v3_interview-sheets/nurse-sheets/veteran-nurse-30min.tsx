    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader className="bg-blue-50">
          <CardTitle className="text-2xl">ベテラン看護師（11年目以上）定期面談シート（30分版）</CardTitle>
          ...
          <Alert className="mt-3">
            ...
            <AlertDescription>
              30分の標準面談です。専門性発揮、知識継承、組織貢献を重点的に確認してください。
            </AlertDescription>
          </Alert>
        </CardHeader>
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">1. 専門性・組織貢献（8分）</h3>
            ...
            <div className="bg-gray-50 p-4 rounded-lg space-y-3">
              ...
              <div className="grid grid-cols-6 gap-2 text-xs text-center font-medium text-gray-600 mb-2">
                ...
                <div className="bg-red-100 px-2 px-1 rounded">1</div>
              </div>
            ...
            <div className="space-y-2">
              <Label>現在の専門領域・エキスパート分野</Label>
              <Textarea 
                placeholder="認定・専門看護師分野、得意領域、院内外での専門的活動"
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="質改善、業務効率化、新人育成、研修企画などの実績"
          ...
          {/* 3. 知識継承・後進育成（5分） */}
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">3. 知識継承・後進育成（5分）</h3>
            
            <div className="space-y-2">
              <Label>現在の指導・メンタリング役割</Label>
              <Textarea 
                placeholder="プリセプター、教育担当、研修講師、委員会活動など具体的な役割"
                className="min-h-[80px]"
              />
            </div>

            <div className="space-y-2">
              <Label>知識・技術継承の取り組み</Label>
              <Textarea 
                placeholder="マニュアル作成、勉強会開催、OJT、ノウハウの文書化など"
                className="min-h-[60px]"
              />
            </div>

            <div className="space-y-2">
              <Label>後進育成での課題・工夫</Label>
              <Textarea 
                placeholder="世代間ギャップ、指導方法の工夫、モチベーション向上など"
                className="min-h-[60px]"
              />
            </div>
          </div>
          ...
          {/* 4. キャリア・働き方（4分） */}
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">4. キャリア・働き方（4分）</h3>
            ...
            <div className="space-y-2">
              <Label>今度チャレンジしたいこと・関心分野</Label>
              <Textarea 
                placeholder="新しい専門分野、管理職、教育・研究、院外活動など"
                className="min-h-[60px]"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="定年に向けた準備、セカンドキャリア、生活設計など"
                className="min-h-[60px]"
              />
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label>今年度内の目標</Label>
              <Textarea 
                placeholder="後進育成、専門性向上、新しい取り組みなど"
                className="min-h-[60px]"
              />
            </div>
          ...
          <div className="space-y-4 border-t pt-4">
            ...
            <Textarea 
              placeholder="特記事項、活用方針、今後の期待役割など"
