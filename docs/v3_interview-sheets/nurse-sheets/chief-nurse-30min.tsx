...
export default function ChiefNurse30MinInterviewSheet() {
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader className="bg-blue-50">
          <CardTitle className="text-2xl">看護師長・管理職定期面談シート（30分版）</CardTitle>
          ...
          <Alert className="mt-3">
            ...
            <AlertDescription>
              30分の標準面談です。管理業務、チーム運営、戦略企画を重点的に確認してください。
            </AlertDescription>
          </Alert>
        </CardHeader>
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">1. 管理業務・チーム運営（8分）</h3>
            ...
            <div className="space-y-2">
              <Label>現在のチーム状況・パフォーマンス</Label>
              <Textarea 
                placeholder="スタッフ数、稼働状況、チームの強み・課題、最近の成果など"
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="新人指導、スキルアップ支援、キャリア開発など"
          ...
          {/* 3. 戦略・改善計画（5分） */}
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">3. 戦略・改善計画（5分）</h3>
            
            <div className="space-y-2">
              <Label>重点取り組み課題・戦略</Label>
              <Textarea 
                placeholder="品質向上、効率化、人材育成、チーム力強化などの戦略と具体的計画"
                className="min-h-[80px]"
              />
            </div>

            <div className="space-y-2">
              <Label>最近の成果・実績</Label>
              <Textarea 
                placeholder="KPI改善、プロジェクト成功事例、チーム成果など"
                className="min-h-[60px]"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="人員配置、業務効率、スタッフのモチベーション管理など"
                className="min-h-[60px]"
              />
            </div>
          ...
          {/* 4. 組織・他部門連携（4分） */}
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">4. 組織・他部門連携（4分）</h3>
            
            <div className="space-y-2">
              <Label>他部門との連携状況</Label>
              <Textarea 
                placeholder="医師、薬剤部、リハビリ、事務部門などとの連携状況と課題"
                className="min-h-[80px]"
              />
            </div>

            <div className="space-y-2">
              <Label>組織全体への貢献・提案</Label>
              <Textarea 
                placeholder="病院全体の改善提案、委員会活動、プロジェクト参加など"
                className="min-h-[60px]"
              />
            </div>
          </div>
          ...
          {/* 5. 今後の目標・キャリア（3分） */}
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">5. 今後の目標・キャリア（3分）</h3>
            
            <div className="space-y-2">
              <Label>次回面談までの目標（1ヶ月）</Label>
              <Textarea 
                placeholder="具体的な管理目標・チーム改善目標・個人目標"
                className="min-h-[60px]"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="部門KPI達成、品質向上、スタッフ育成など"
                className="min-h-[60px]"
              />
            </div>
          ...
          <div className="space-y-4 border-t pt-4">
            ...
            <Textarea 
              placeholder="特記事項、支援方針、今後の期待役割など"
