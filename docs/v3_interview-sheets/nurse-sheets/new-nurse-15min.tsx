      ...
      <Card>
        <CardHeader className="bg-blue-50">
          ...
          <Alert className="mt-3">
            ...
            <AlertDescription>
              15分の短時間面談です。重要な確認事項に絞って効率的に進めてください。
            </AlertDescription>
          </Alert>
        </CardHeader>
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">1. 適応状況の確認（3分）</h3>
            ...
            <div className="bg-gray-50 p-4 rounded-lg space-y-3">
              ...
              <RadioGroup>
                <div className="grid grid-cols-6 gap-2 items-center">
                  <span className="text-sm font-medium">職場適応</span>
          ...
          {/* 3. 課題・サポート（3分） */}
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">3. 課題・サポート（3分）</h3>
