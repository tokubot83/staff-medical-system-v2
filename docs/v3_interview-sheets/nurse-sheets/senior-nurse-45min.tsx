...
export default function SeniorNurse45MinInterviewSheet() {
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader className="bg-blue-50">
          <CardTitle className="text-2xl">中堅看護師（4-10年目）定期面談シート（45分版）</CardTitle>
          ...
          <Alert className="mt-3">
            ...
            <AlertDescription>
              45分の詳細面談です。リーダーシップ開発、専門性向上、組織貢献を包括的に支援してください。
            </AlertDescription>
          </Alert>
        </CardHeader>
        <CardContent className="space-y-6 pt-6">
          {/* 1. リーダーシップ・専門性の詳細評価（12分） */}
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">1. リーダーシップ・専門性の詳細評価（12分）</h3>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="困難な状況での判断、チームをまとめた経験、変革を推進した事例など"
                className="min-h-[80px]"
              />
            </div>

            <div className="space-y-2">
              <Label>現在のリーダーシップの課題・改善点</Label>
              <Textarea 
                placeholder="コミュニケーション、意思決定、チーム運営などでの課題"
          ...
          {/* 3. 専門性・キャリア展望の詳細（8分） */}
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">3. 専門性・キャリア展望の詳細（8分）</h3>
            
            <div className="space-y-2">
              <Label>専門分野での取り組み・資格取得状況</Label>
              <Textarea 
                placeholder="認定看護師、専門看護師、その他資格の取得状況、学習計画、専門領域での活動"
                className="min-h-[100px]"
              />
            </div>

            <div className="space-y-2">
              <Label>将来のキャリア方向性と具体的計画</Label>
              ...
              <Textarea 
                placeholder="選択した方向性での具体的なキャリアプラン、必要な準備など"
                className="min-h-[80px]"
              />
            </div>

            <div className="space-y-2">
              <Label>研究・学会活動への関心と実績</Label>
              <Textarea 
                placeholder="研究参加、学会発表、論文執筆、勉強会企画などの経験や今後の計画"
                className="min-h-[80px]"
              />
            </div>

            <div className="space-y-2">
              <Label>継続学習・自己啓発の取り組み</Label>
              <Textarea 
                placeholder="院内外研修、資格取得、読書、オンライン学習などの具体的な取り組み"
                className="min-h-[60px]"
              />
            </div>

            <div className="space-y-2">
              <Label>他職種・他部門との連携・ネットワーク</Label>
              <Textarea 
                placeholder="医師、薬剤師、リハビリなど他職種との連携経験、院内外のネットワーク"
                className="min-h-[60px]"
              />
            </div>
          </div>
          ...
          {/* 4. 組織貢献・変革推進（5分） */}
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">4. 組織貢献・変革推進（5分）</h3>
            
            <div className="space-y-2">
              <Label>現在のチーム・病棟への具体的貢献</Label>
              <Textarea 
                placeholder="質改善、業務効率化、チームワーク向上への具体的な取り組みと成果"
                className="min-h-[100px]"
              />
            </div>

            <div className="space-y-2">
              <Label>変革・改善プロジェクトでの役割</Label>
              <Textarea 
                placeholder="新しい取り組みの企画・実施、業務改善プロジェクトでのリーダーシップ"
                className="min-h-[80px]"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="リーダーシップ、後輩指導、業務負荷、組織運営などの課題"
                className="min-h-[80px]"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="職場環境、業務プロセス、研修制度、評価制度などへの具体的提案"
                className="min-h-[80px]"
              />
            </div>
          </div>
          ...
          {/* 5. ワークライフバランス・生活面（5分） */}
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">5. ワークライフバランス・生活面（5分）</h3>
            
            <div className="space-y-2">
              <Label>現在の勤務・生活状況</Label>
              <Textarea 
                placeholder="家庭状況、育児・介護、プライベートの時間確保など"
                className="min-h-[80px]"
              />
            </div>

            <div className="space-y-2">
              <Label>リーダー役割と私生活の両立</Label>
              <Textarea 
                placeholder="責任ある役割での時間管理、家庭との両立での工夫や困難"
                className="min-h-[80px]"
              />
            </div>

            <div className="space-y-2">
              <Label>今後のライフイベント・働き方の希望</Label>
              <Textarea 
                placeholder="結婚、出産、介護などのライフイベント、希望する働き方の変化"
                className="min-h-[60px]"
              />
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="リーダーシップ向上、専門性強化、メンタリングスキル向上など具体的目標"
                className="min-h-[60px]"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="管理的役割、専門資格、研究活動、組織貢献など"
                className="min-h-[60px]"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="管理職、専門看護師、認定看護師、教育・研究職など具体的な目標"
                className="min-h-[60px]"
              />
            </div>
          ...
          <div className="space-y-4 border-t pt-4">
            ...
            <Textarea 
              placeholder="特記事項、育成方針、キャリア開発支援の方向性、今後の重点支援領域など詳細に記入"
