    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader className="bg-blue-50">
          <CardTitle className="text-2xl">ベテラン看護師（11年目以上）定期面談シート（15分版）</CardTitle>
          ...
          <Alert className="mt-3">
            ...
            <AlertDescription>
              15分の短時間面談です。専門性発揮と知識継承、組織貢献に焦点を当ててください。
            </AlertDescription>
          </Alert>
        </CardHeader>
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">1. 専門性・組織貢献（3分）</h3>
            ...
            <div className="bg-gray-50 p-4 rounded-lg space-y-3">
              ...
              <RadioGroup>
                <div className="grid grid-cols-6 gap-2 items-center">
                  <span className="text-sm font-medium">専門知識活用</span>
                  <div className="flex justify-center">
                    <RadioGroupItem value="expertise-5" id="expertise-5" className="w-4 h-4" />
                  </div>
                  <div className="flex justify-center">
                    <RadioGroupItem value="expertise-4" id="expertise-4" className="w-4 h-4" />
                  </div>
                  <div className="flex justify-center">
                    <RadioGroupItem value="expertise-3" id="expertise-3" className="w-4 h-4" />
                  </div>
                  <div className="flex justify-center">
                    <RadioGroupItem value="expertise-2" id="expertise-2" className="w-4 h-4" />
                  </div>
                  <div className="flex justify-center">
                    <RadioGroupItem value="expertise-1" id="expertise-1" className="w-4 h-4" />
                  </div>
                </div>
              </RadioGroup>
          ...
          {/* 3. 知識継承・後進育成（3分） */}
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">3. 知識継承・後進育成（3分）</h3>
            
            <div className="space-y-2">
              <Label>現在の指導・メンタリング役割</Label>
              <Textarea 
                placeholder="プリセプター、教育担当、研修講師など"
                className="min-h-[60px]"
              />
            </div>
