      ...
      <Card>
        <CardHeader className="bg-blue-50">
          ...
          <Alert className="mt-3">
            ...
            <AlertDescription>
              30分の標準面談です。適応状況と学習進捗を重点的に確認してください。
            </AlertDescription>
          </Alert>
        </CardHeader>
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">1. 適応状況の確認（8分）</h3>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="同期とのコミュニケーション、勉強会への参加状況など"
          ...
          {/* 3. 学習・成長状況（5分） */}
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">3. 学習・成長状況（5分）</h3>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="技術習得、知識の定着などで困っていること"
                className="min-h-[60px]"
              />
            </div>
          </div>
          ...
          {/* 4. 課題・サポート（4分） */}
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">4. 課題・サポート（4分）</h3>
            
            <div className="space-y-2">
              <Label>現在困っていること・不安なこと</Label>
              <Textarea 
                placeholder="業務面、人間関係、体調面など"
                className="min-h-[80px]"
              />
            </div>
          ...
          <div className="space-y-4 border-t pt-4">
            ...
            <Textarea 
              placeholder="特記事項、緊急対応事項、成長の兆候など"
