...
export default function SeniorNurse15MinInterviewSheet() {
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader className="bg-blue-50">
          <CardTitle className="text-2xl">中堅看護師（4-10年目）定期面談シート（15分版）</CardTitle>
          ...
          <Alert className="mt-3">
            ...
            <AlertDescription>
              15分の短時間面談です。リーダーシップ開発と専門性向上に焦点を当ててください。
            </AlertDescription>
          </Alert>
        </CardHeader>
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">1. リーダーシップ・専門性（3分）</h3>
            ...
            <div className="bg-gray-50 p-4 rounded-lg space-y-3">
              ...
              <RadioGroup>
                <div className="grid grid-cols-6 gap-2 items-center">
                  <span className="text-sm font-medium">リーダーシップ</span>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="チームリーダー、委員会、プロジェクトなど"
          ...
          {/* 3. 専門性・キャリア展望（3分） */}
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">3. 専門性・キャリア展望（3分）</h3>
            
            <div className="space-y-2">
              <Label>専門分野での取り組み・資格取得状況</Label>
              <Textarea 
                placeholder="認定看護師、専門看護師、その他資格など"
                className="min-h-[60px]"
              />
            </div>
