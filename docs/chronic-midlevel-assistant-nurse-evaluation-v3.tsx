...
export default function ChronicMidlevelAssistantNurseEvaluationV3() {
  return (
    <div className="container mx-auto py-10 px-4 max-w-5xl">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            【慢性期医療】中堅准看護師（4-10年目） 人事評価シート
          </CardTitle>
        ...
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              中堅准看護師は慢性期ケアのリーダーシップ発揮と専門性の深化を評価します
            </AlertDescription>
          </Alert>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="leadership-s" className="font-normal">
                          <span className="font-semibold">S：</span> 卓越したリーダーシップで慢性期ケアの質を向上させる
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="education-s" className="font-normal">
                          <span className="font-semibold">S：</span> 体系的な慢性期ケア教育を実施し、多くの人材を育成
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="management-s" className="font-normal">
                          <span className="font-semibold">S：</span> 准看護師リーダーとして病棟運営の中核を担う
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="management-c" className="font-normal">
                          <span className="font-semibold">C：</span> 運営業務への関わりが限定的
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="expertise-s" className="font-normal">
                          <span className="font-semibold">S：</span> 慢性期ケアのエキスパートとして最高レベルの実践を行う
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="contribution-s" className="font-normal">
                          <span className="font-semibold">S：</span> 法人の慢性期ケア方針に参画し、質向上をリード
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
              ...
              <div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="中堅准看護師としての慢性期ケア実践、強み、今後の方向性など"
            ...
            <TabsContent value="development" className="space-y-6 mt-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea 
                    id="support-plan" 
                    placeholder="認知症ケア指導者研修、准看護師リーダー研修、外部専門研修など"
                    className="min-h-[100px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="career-vision" 
                    placeholder="慢性期ケア専門准看護師、主任職、認知症ケアエキスパートなど"
                    className="min-h-[80px]"
                  />
                </div>
