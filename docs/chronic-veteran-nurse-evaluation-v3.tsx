...
export default function ChronicVeteranNurseEvaluationV3() {
  return (
    <div className="container mx-auto py-10 px-4 max-w-5xl">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            【慢性期医療】ベテラン看護師（11年目以上） 人事評価シート
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            慢性期ケアの組織影響力と次世代育成を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ベテラン看護師は慢性期ケアの組織への影響力と知識・技術の継承を評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="facility" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  慢性期ケア文化の醸成と次世代育成を中心に評価
                </p>
              </div>

              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold mb-3">1. 慢性期ケア文化への影響力</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="culture-s" />
                        <Label htmlFor="culture-s" className="font-normal">
                          <span className="font-semibold">S：</span> 慢性期ケア文化の形成に中心的役割を果たし、全体に好影響
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  <h4 className="font-semibold mb-3">2. 慢性期ケア知識・技術の継承</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="succession-s" />
                        <Label htmlFor="succession-s" className="font-normal">
                          <span className="font-semibold">S：</span> 体系的な慢性期ケア継承システムを構築し、多くの後継者を育成
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  <h4 className="font-semibold mb-3">3. 慢性期ケアの変革への貢献</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="change-s" />
                        <Label htmlFor="change-s" className="font-normal">
                          <span className="font-semibold">S：</span> 慢性期ケアの変革をリードし、新しい取り組みを推進
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
            ...
            <TabsContent value="corporate" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  卓越した慢性期ケア実践と法人への貢献を中心に評価
                </p>
              </div>

              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold mb-3">1. 卓越した慢性期看護実践</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="mastery-s" />
                        <Label htmlFor="mastery-s" className="font-normal">
                          <span className="font-semibold">S：</span> 慢性期看護の最高峰として法人内外で認められる
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  <h4 className="font-semibold mb-3">2. 慢性期ケア戦略への貢献</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="strategy-s" />
                        <Label htmlFor="strategy-s" className="font-normal">
                          <span className="font-semibold">S：</span> 法人の慢性期ケア戦略立案に参画し、実現に大きく貢献
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  <h4 className="font-semibold mb-3">3. 地域・外部への影響力</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="external-s" />
                        <Label htmlFor="external-s" className="font-normal">
                          <span className="font-semibold">S：</span> 地域の慢性期ケアをリードし、業界発展に貢献
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="卓越した慢性期ケア実践例、法人戦略への貢献、外部での活動など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="ベテラン看護師としての慢性期ケアへの貢献、組織への影響、今後の活躍など"
            ...
            <TabsContent value="development" className="space-y-6 mt-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Textarea 
                    id="strengths" 
                    placeholder="豊富な慢性期ケア経験、認知症ケアの専門性、終末期ケアの実践力など"
                ...
                <div>
                  ...
                  <Textarea 
                    id="activation-areas" 
                    placeholder="新しい慢性期ケアへの適応、モチベーション向上など"
                    className="min-h-[80px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="special-mission" 
                    placeholder="慢性期ケア教育プログラム開発、認知症ケアマニュアル作成、終末期ケアチーム立ち上げなど"
                    className="min-h-[100px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="succession-plan" 
                    placeholder="慢性期ケア勉強会講師、認知症ケア事例検討会、メンタリング活動など"
                    className="min-h-[100px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="慢性期ケア専門アドバイザー、教育専任、管理職への転換など"
                    className="min-h-[80px]"
                  />
                </div>
