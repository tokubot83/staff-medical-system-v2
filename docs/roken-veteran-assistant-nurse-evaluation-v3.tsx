...
export default function RokenVeteranAssistantNurseEvaluationV3() {
  return (
    <div className="container mx-auto py-10 px-4 max-w-5xl">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            介護老人保健施設 ベテラン准看護師（11年以上） 人事評価シート
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            豊富な経験の活用と組織貢献を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ベテラン准看護師として豊富な経験を組織のために活用し、知識継承と後進育成への貢献を評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="basic" className="space-y-4 mt-6">
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  <div>
                    <Label htmlFor="specialty">専門分野・得意分野</Label>
                    <Input type="text" id="specialty" placeholder="認知症ケア / 終末期ケア" />
                  </div>
                  <div>
                    <Label htmlFor="certifications">保有資格・研修</Label>
                    <Input type="text" id="certifications" placeholder="認知症ケア専門士" />
                  </div>
                </div>
              </div>
            ...
            <TabsContent value="facility" className="space-y-6 mt-6">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold mb-3">1. 組織全体への影響力</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="influence-s" />
                        <Label htmlFor="influence-s" className="font-normal">
                          <span className="font-semibold">S：</span> 施設全体の質向上に決定的な貢献をし、組織の要となる
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="succession-s" className="font-normal">
                          <span className="font-semibold">S：</span> 体系的な教育プログラムを構築し、多数の優秀な人材を育成
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="a" id="succession-a" />
                        <Label htmlFor="succession-a" className="font-normal">
                          <span className="font-semibold">A：</span> 積極的に知識・技術を伝承し、後進の成長に大きく貢献
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="culture-s" className="font-normal">
                          <span className="font-semibold">S：</span> 老健の理念を体現し、全職員の模範となるリーダー
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
            ...
            <TabsContent value="corporate" className="space-y-6 mt-6">
              ...
              <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="expertise-s" className="font-normal">
                          <span className="font-semibold">S：</span> 卓越した専門性で最困難事例も解決し、新たなケア手法を開発
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  <h4 className="font-semibold mb-3">2. 在宅復帰支援への熟練した貢献</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="home-expert-s" />
                        <Label htmlFor="home-expert-s" className="font-normal">
                          <span className="font-semibold">S：</span> 豊富な経験により困難事例の在宅復帰を多数実現
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="a" id="home-expert-a" />
                        <Label htmlFor="home-expert-a" className="font-normal">
                          <span className="font-semibold">A：</span> 熟練した技術で在宅復帰率向上に大きく貢献
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="b" id="home-expert-b" />
                        <Label htmlFor="home-expert-b" className="font-normal">
                          <span className="font-semibold">B：</span> 確実な在宅復帰支援を実践
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="c" id="home-expert-c" />
                        <Label htmlFor="home-expert-c" className="font-normal">
                          <span className="font-semibold">C：</span> 在宅復帰支援への貢献が不十分
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="d" id="home-expert-d" />
                        <Label htmlFor="home-expert-d" className="font-normal">
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="専門実践の成果、在宅復帰支援での実績、ケア革新への貢献など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
            ...
            <TabsContent value="contribution" className="space-y-6 mt-6">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold mb-3">これまでの主な貢献</h4>
                  <div className="space-y-2">
                    <Checkbox id="contribution-education" />
                    <Label htmlFor="contribution-education" className="ml-2">教育プログラムの構築・改善</Label>
                  </div>
                  <div className="space-y-2 mt-2">
                    <Checkbox id="contribution-manual" />
                    <Label htmlFor="contribution-manual" className="ml-2">業務マニュアル・手順書の作成</Label>
                  </div>
                  <div className="space-y-2 mt-2">
                    <Checkbox id="contribution-quality" />
                    <Label htmlFor="contribution-quality" className="ml-2">ケア質向上プロジェクトの推進</Label>
                  </div>
                  <div className="space-y-2 mt-2">
                    <Checkbox id="contribution-committee" />
                    <Label htmlFor="contribution-committee" className="ml-2">各種委員会での中心的役割</Label>
                  </div>
                  <div className="space-y-2 mt-2">
                    <Checkbox id="contribution-external" />
                    <Label htmlFor="contribution-external" className="ml-2">外部研修・講師活動</Label>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="指導した職員の成長、リーダーへの昇格者数、資格取得支援の成果など"
                    className="min-h-[80px]"
                  />
                </div>

                <div>
                  <Label htmlFor="special-expertise">保有する独自の専門知識・技術</Label>
                  <Textarea 
                    id="special-expertise" 
                    placeholder="長年の経験で培った特殊技術、困難事例への対応ノウハウなど"
                    className="min-h-[80px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="新たなケア手法の開発、業務改善の成果、在宅復帰率向上への貢献など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-6 mb-6">
                  ...
                  <div className="bg-green-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">専門実践・革新・在宅復帰</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="ベテラン准看護師としての価値、組織への貢献度、今後の活用方針など"
            ...
            <TabsContent value="succession" className="space-y-6 mt-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Textarea 
                    id="unique-expertise" 
                    placeholder="老健ケアの深い経験知、特殊な技術、人脈、歴史的経緯の理解など"
                    className="min-h-[80px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="教育専任、相談役、特命プロジェクト、委員会アドバイザーなど"
                    className="min-h-[80px]"
                  />
                </div>

                <div>
                  <Label htmlFor="development-support">さらなる活躍のための支援</Label>
                  <Textarea 
                    id="development-support" 
                    placeholder="研修機会の提供、外部活動の支援、看護師資格取得支援など"
                    className="min-h-[80px]"
                  />
                </div>
