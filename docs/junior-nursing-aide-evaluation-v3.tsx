...
export default function JuniorNursingAideEvaluationV3() {
  return (
      ...
      <Card>
        ...
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              2・3年目看護補助者は実践能力の向上と後輩指導への関わりを評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="role-s" className="font-normal">
                          <span className="font-semibold">S：</span> 補助者チームの中心として病棟運営に貢献
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
            ...
            <TabsContent value="corporate" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  看護補助実践能力の深化と専門性を中心に評価
                </p>
              </div>

              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold mb-3">1. 看護補助実践能力の向上</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="practice-s" />
                        <Label htmlFor="practice-s" className="font-normal">
                          <span className="font-semibold">S：</span> 高度な実践能力を持ち、複雑な業務にも対応可能
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="knowledge-s" className="font-normal">
                          <span className="font-semibold">S：</span> 最新知識を積極的に学び、業務の質向上に活かす
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="優れた実践例、患者満足度向上の具体例、学習成果など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="2・3年目看護補助者としての成長度、強み、今後の可能性など"
            ...
            <TabsContent value="development" className="space-y-6 mt-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Textarea 
                    id="strengths" 
                    placeholder="実践能力、後輩指導力、患者サービスなど"
                ...
                <div>
                  <Label htmlFor="career-vision">中堅看護補助者に向けての展望</Label>
                  <Textarea 
                    id="career-vision" 
