...
export default function NewAssistantNurseEvaluationV3() {
  return (
      ...
      <Card>
        ...
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              新人准看護師は基礎技術の習得状況に加え、職場への適応とチームへの貢献姿勢を評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="facility" className="space-y-6 mt-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h4 className="font-semibold mb-3">2. 学習姿勢と知識共有</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="learn-s" />
                        <Label htmlFor="learn-s" className="font-normal">
                          <span className="font-semibold">S：</span> 主体的に学習し、得た知識を同期や後輩と積極的に共有
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
            ...
            <TabsContent value="corporate" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  准看護実践能力と知識の活用度を中心に評価
                </p>
              </div>

              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold mb-3">1. 基礎看護技術の習得と実践</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="skill-s" />
                        <Label htmlFor="skill-s" className="font-normal">
                          <span className="font-semibold">S：</span> 准看護師として求められる技術を完全習得し、安全・確実に実践
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="優れた実践例、患者・家族からの評価、看護師との協働など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-6 mb-6">
                  ...
                  <div className="bg-green-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">実践能力・知識活用</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="新人准看護師としての成長度、強み、今後の可能性など"
            ...
            <TabsContent value="development" className="space-y-6 mt-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Textarea 
                    id="strengths" 
                    placeholder="積極的な学習姿勢、患者への接し方、チームワークなど"
                ...
                <div>
                  ...
                  <Textarea 
                    id="growth-areas" 
                    placeholder="技術面での課題、報告・連絡・相談の改善点など"
                    className="min-h-[80px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="next-goals" 
                    placeholder="独り立ち項目、新たな技術習得、協働スキルの向上など"
                    className="min-h-[100px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="support-plan" 
                    placeholder="指導体制の継続、特定分野の研修、メンタルサポートなど"
                    className="min-h-[100px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="career-vision" 
                    placeholder="期待される成長、役割の変化、キャリアの方向性など"
                    className="min-h-[80px]"
                  />
                </div>
