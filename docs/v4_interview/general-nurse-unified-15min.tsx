...
export default function GeneralNurseUnified15MinInterviewSheet() {
  return (
      ...
      <Card>
        <CardHeader className="bg-amber-50">
          ...
          <Alert className="mt-3">
            ...
            <AlertDescription>
              15分の短時間面談です。一般看護師の現状把握と、緊急性の高い課題を特定することを目的とします。
            </AlertDescription>
          </Alert>
        </CardHeader>
        <CardContent className="space-y-6 pt-6">
          ...
          {/* 2. 職員の現状確認（モチベーション・健康・エンゲージメント）（5分） - 全世代共通セクション */}
          ...
          <div className="space-y-4 border-t pt-4">
            ...
            <Textarea 
              placeholder="特記事項、緊急対応が必要な事項があれば記入"
