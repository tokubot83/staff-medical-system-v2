...
export default function GeneralNurseUnified30MinInterviewSheet() {
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader className="bg-amber-50">
          <CardTitle className="text-2xl">一般看護師（2-3年目）定期面談シート（30分版）</CardTitle>
          ...
          <Alert className="mt-3">
            ...
            <AlertDescription>
              30分の標準面談です。一般看護師の成長評価と今後の育成方針を明確にすることを目的とします。
            </AlertDescription>
          </Alert>
        </CardHeader>
        <CardContent className="space-y-6 pt-6">
          ...
          {/* 2. 職員の現状確認（モチベーション・健康・エンゲージメント）（8分） - 全世代共通セクション */}
