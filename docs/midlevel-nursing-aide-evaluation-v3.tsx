...
export default function MidlevelNursingAideEvaluationV3() {
  return (
    <div className="container mx-auto py-10 px-4 max-w-5xl">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            中堅看護補助者（4-10年目） 人事評価シート
          </CardTitle>
        ...
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              中堅看護補助者はリーダーシップの発揮と専門性の深化を評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="facility" className="space-y-6 mt-6">
              ...
              <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="leadership-s" className="font-normal">
                          <span className="font-semibold">S：</span> 卓越したリーダーシップで補助者チームを牽引
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  <h4 className="font-semibold mb-3">3. 病棟運営・業務管理</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="management-s" />
                        <Label htmlFor="management-s" className="font-normal">
                          <span className="font-semibold">S：</span> 補助者業務の効率化を主導し、病棟運営に大きく貢献
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
              ...
              <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="expertise-s" className="font-normal">
                          <span className="font-semibold">S：</span> 看護補助者として最高レベルの実践能力を持ち、模範となる
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="a" id="expertise-a" />
                        <Label htmlFor="expertise-a" className="font-normal">
                          <span className="font-semibold">A：</span> 高度な実践能力を持ち、困難な状況にも対応可能
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        ...
                        <Label htmlFor="contribution-s" className="font-normal">
                          <span className="font-semibold">S：</span> 法人レベルの活動に参画し、補助者業務の発展に貢献
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="専門的実践の具体例、サービス品質向上の成果、法人への貢献など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="中堅看護補助者としての総合評価、強み、今後の方向性など"
            ...
            <TabsContent value="development" className="space-y-6 mt-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea 
                    id="next-goals" 
                    placeholder="リーダー職への挑戦、専門分野の確立、教育体制の構築など"
                    className="min-h-[100px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="support-plan" 
                    placeholder="リーダー研修、専門研修、外部研修など"
                    className="min-h-[100px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="career-vision" 
                    placeholder="補助者リーダー、専門分野のエキスパート、教育責任者など"
                    className="min-h-[80px]"
                  />
                </div>
