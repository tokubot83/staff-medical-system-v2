...
export default function ChronicChiefNurseEvaluationV3() {
  return (
      ...
      <Card>
        ...
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              主任看護師は慢性期ケアの管理能力とチーム統括力、組織運営への貢献を評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="facility" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  慢性期病棟のチーム管理と運営への貢献を中心に評価
                </p>
              </div>

              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold mb-3">1. 慢性期ケアチームの管理・統括</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="team-mgmt-s" />
                        <Label htmlFor="team-mgmt-s" className="font-normal">
                          <span className="font-semibold">S：</span> 卓越した管理能力で慢性期ケアチームを統括し、高い成果を達成
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  <h4 className="font-semibold mb-3">2. 慢性期ケア人材育成・能力開発</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="hr-dev-s" />
                        <Label htmlFor="hr-dev-s" className="font-normal">
                          <span className="font-semibold">S：</span> 体系的な慢性期ケア育成システムを構築し、優秀な人材を輩出
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  <h4 className="font-semibold mb-3">3. 療養病棟運営への参画</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="ward-ops-s" />
                        <Label htmlFor="ward-ops-s" className="font-normal">
                          <span className="font-semibold">S：</span> 師長と協働し、療養病棟運営を主導的に改善
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
            ...
            <TabsContent value="corporate" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  慢性期ケア管理職としての能力と法人運営への貢献を中心に評価
                </p>
              </div>

              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold mb-3">1. 慢性期ケア管理職としての実践</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="mgmt-practice-s" />
                        <Label htmlFor="mgmt-practice-s" className="font-normal">
                          <span className="font-semibold">S：</span> 模範的な慢性期ケア管理実践で他の主任の手本となる
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  <h4 className="font-semibold mb-3">3. 慢性期ケア改革・イノベーション</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="innovation-s" />
                        <Label htmlFor="innovation-s" className="font-normal">
                          <span className="font-semibold">S：</span> 革新的な慢性期ケアを実現し、法人全体に展開
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="管理実践の成果、質向上への貢献、改革実績など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="主任看護師として慢性期ケア管理の総合評価、強み、今後の展望など"
            ...
            <TabsContent value="development" className="space-y-6 mt-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Textarea 
                    id="strengths" 
                    placeholder="慢性期ケアリーダーシップ、チーム管理力、育成力など"
                ...
                <div>
                  ...
                  <Textarea 
                    id="management-goals" 
                    placeholder="慢性期ケアの質向上、チーム業績向上、人材育成成果など"
                    className="min-h-[100px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="training-plan" 
                    placeholder="慢性期ケア管理研修、認知症ケア指導者研修、外部セミナーなど"
                    className="min-h-[100px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="career-path" 
                    placeholder="師長職、慢性期ケア専門管理職、看護部スタッフなど"
                    className="min-h-[80px]"
                  />
                </div>
