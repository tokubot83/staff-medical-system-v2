...
export default function MidlevelOutpatientNurseEvaluationV4Pattern5() {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            外来中堅看護師（4-7年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 外来専門性向上とリーダーシップを重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              <br />
              4-7年目は外来での専門的実践、リーダーシップ、業務改善への主体的な取り組みを評価します
            </AlertDescription>
          </Alert>
            ...
            <TabsContent value="technical" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  ...
                  <br />
                  外来での専門的実践、高度なトリアージ、チームリーダーシップを重視
                </p>
              </div>
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-4">
                  <div>
                    <Label className="text-sm font-medium">1. 外来専門看護技術の実践（高度な処置・判断）</Label>
                  ...
                  <div>
                    <Label className="text-sm font-medium">2. 高度トリアージ・緊急対応（救急患者対応・病棟調整の統括）</Label>
                  ...
                  <div>
                    <Label className="text-sm font-medium">3. 患者教育・家族支援（専門的な指導・困難事例への対応）</Label>
                  ...
                  <div>
                    <Label className="text-sm font-medium">4. チームリーダーシップ・スタッフ育成（メンタリング・教育計画立案）</Label>
