...
export default function VeteranOutpatientNurseEvaluationV4Pattern5() {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            外来ベテラン看護師（8年目以上） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 外来エキスパートと組織貢献を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              <br />
              8年目以上は外来エキスパートとしての卓越した実践、組織全体への貢献、後継者育成を評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  ...
                  <div>
                    ...
                    <Input type="text" id="experience" placeholder="10年目" />
                  </div>
                </div>
              </div>
            ...
            <TabsContent value="technical" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  ...
                  <br />
                  外来エキスパートとしての卓越した実践、組織運営への参画を重視
                </p>
              </div>
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-4">
                  <div>
                    <Label className="text-sm font-medium">1. 外来エキスパート看護実践（最高度の判断・指導）</Label>
                  ...
                  <div>
                    <Label className="text-sm font-medium">2. 組織的トリアージ体制構築（システム改善・標準化推進）</Label>
                  ...
                  <div>
                    <Label className="text-sm font-medium">3. 高度患者支援・コンサルテーション（困難事例対応・他職種連携）</Label>
                  ...
                  <div>
                    <Label className="text-sm font-medium">4. 組織運営・後継者育成（外来運営参画・指導者育成）</Label>
            ...
            <TabsContent value="facility" className="space-y-6 mt-6">
              ...
              <div className="border rounded-lg overflow-hidden">
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      <TableCell>プリセプター統括・教育プログラム開発</TableCell>
                    ...
                    <TableRow>
                      <TableCell>外来運営改革・新規プロジェクト主導</TableCell>
                    ...
                    <TableRow>
                      <TableCell>外来全体統括・特殊外来担当</TableCell>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <h4 className="font-semibold mb-3">施設内相対評価（外来ベテラン看護師間）</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div>
            ...
            <TabsContent value="corporate" className="space-y-6 mt-6">
              ...
              <div className="bg-orange-50 p-4 rounded-lg">
                <h4 className="font-semibold mb-3">法人内相対評価（全ベテラン看護師間）</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div>
              ...
              <div>
                ...
                <div className="mt-6 space-y-4">
                  <div>
                    ...
                    <Textarea 
                      id="next-challenges" 
                      placeholder="外来システム全体の最適化、次世代リーダー育成、地域連携強化など"
                  ...
                  <div>
                    ...
                    <Textarea 
                      ...
                      placeholder="外来運営への貢献、エキスパートとしての指導力、組織発展への寄与などを記入"
                      className="min-h-[100px]"
                    />
                  </div>
                </div>
