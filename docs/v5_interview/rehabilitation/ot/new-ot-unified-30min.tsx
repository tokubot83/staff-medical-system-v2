...
export default function NewOTUnified30MinInterviewSheetV5() {
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader className="bg-teal-50">
          <CardTitle className="text-2xl">新人作業療法士（1年目）定期面談シート V5（30分版）</CardTitle>
          ...
          <Alert className="mt-3">
            ...
            <AlertDescription>
              30分の標準面談です。<strong>動機タイプ判定</strong>を活用し、新人作業療法士の基礎技術習得と今後の育成方針を明確にします。
            </AlertDescription>
          </Alert>
        </CardHeader>
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="担当患者数、疾患領域、ADL・認知機能訓練の実施状況、作業活動の選択能力、達成度など詳しく記入"
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="評価技術向上、作業活動の理解、患者対応、精神機能へのアプローチなど具体的に"
                className="min-h-[80px]"
              />
            </div>
          </div>
                ...
                <div className="space-y-3">
                  {typeSpecificQuestions.slice(0, 2).map((question, index) => (
                    <div key={index} className="space-y-2">
                      ...
                      <Textarea 
                        placeholder="作業療法士としての視点で詳しくお答えください"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="ADL評価、認知機能訓練、作業活動の選択、患者の精神面へのアプローチ、環境調整などの具体的な課題"
                className="min-h-[80px]"
              />
            </div>
          ...
          <div className="space-y-4">
              ...
              <Alert className="bg-purple-50 border-purple-200">
                <AlertDescription>
                  ...
                  <div className="mt-1 text-sm">
                    {selectedMotivationType === 'growth' && 'ADL・認知機能評価技術研修、作業活動研修、専門資格取得準備'}
                    {selectedMotivationType === 'recognition' && '技術向上の成果評価、院内発表機会、症例報告作成支援'}
                    {selectedMotivationType === 'stability' && '基本技術の確実な習得、段階的な症例担当、安定した指導体制'}
                    {selectedMotivationType === 'teamwork' && 'チーム医療での役割理解、多職種連携強化、患者・家族対応向上'}
                    {selectedMotivationType === 'efficiency' && '効率的評価・訓練手順習得、時間管理研修、記録作成技術向上'}
                    {selectedMotivationType === 'compensation' && '昇進要件明示、資格取得支援、専門手当制度説明'}
                    {selectedMotivationType === 'creativity' && '独自作業活動開発支援、創造的アプローチ奨励、新しい訓練方法学習'}
                  </div>
                </AlertDescription>
              </Alert>
            )}
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="具体的で測定可能な目標を設定（例：特定疾患のADL評価技術習得、認知機能訓練プログラム実施など）"
                className="min-h-[60px]"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="専門性向上、業務範囲拡大、研修参加などの目標"
                className="min-h-[60px]"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input type="text" id="follow-method" placeholder="月次1on1、週次指導など" />
              </div>
            </div>
          </div>
