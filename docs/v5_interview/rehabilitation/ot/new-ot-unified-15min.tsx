...
export default function NewOTUnified15MinInterviewSheetV5() {
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader className="bg-teal-50">
          <CardTitle className="text-2xl">新人作業療法士（1年目）定期面談シート V5（15分版）</CardTitle>
          ...
          <Alert className="mt-3">
            ...
            <AlertDescription>
              15分の簡潔面談です。<strong>動機タイプ判定</strong>と新人作業療法士の基本的な適応状況を確認します。
            </AlertDescription>
          </Alert>
        </CardHeader>
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="ADL評価、認知機能評価、上肢機能訓練、患者対応など"
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="日常生活動作評価、作業活動選択、高次脳機能評価、記録など"
                className="min-h-[60px]"
              />
            </div>
            ...
            <div className="space-y-4 bg-teal-50 p-4 rounded-lg">
              ...
              <div className="bg-purple-50 p-4 rounded-lg space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea 
                    placeholder="作業療法士としての視点でお答えください"
                    className="min-h-[60px]"
                  />
                </div>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input 
                placeholder="例：ADL評価の精度向上、認知機能訓練プログラムの習得"
              />
            </div>
            ...
            <div className="space-y-2">
              <Label>必要なサポート</Label>
              <Textarea 
                placeholder="先輩からの技術指導、症例検討、作業活動の選択方法、環境調整の学習など"
                className="min-h-[60px]"
              />
            </div>
          </div>
