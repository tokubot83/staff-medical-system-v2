...
export default function ChiefOTUnified45MinInterviewSheetV5() {
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader className="bg-teal-50">
          <CardTitle className="text-2xl">主任作業療法士定期面談シート V5（45分版）</CardTitle>
          ...
          <Alert className="mt-3">
            ...
            <AlertDescription>
              45分の詳細面談です。<strong>動機タイプ判定</strong>を活用し、主任作業療法士としてのマネジメント能力と部門運営、組織リーダーシップを包括的に評価・支援します。
            </AlertDescription>
          </Alert>
        </CardHeader>
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg space-y-3">
              <Label className="text-base font-semibold">主亻OT管理・リーダーシップ能力の総合評価</Label>
          ...
          <div className="space-y-4 bg-teal-50 p-4 rounded-lg">
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="OT部門の責任者としての使命感、スタッフ育成への責任、組織目標達成へのコミットメントなど"
                className="min-h-[80px]"
              />
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label>今後のOT部門ビジョン・発展計画と戦略</Label>
              <Textarea 
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="OT部門運営に必要な支援、制度改善の提案、組織改革への意見、戦略的課題の指摘、経営への意見など"
                className="min-h-[100px]"
              />
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="OT部門の将来ビジョン、組織全体への貢献、次世代リーダー育成、持続可能な成長戦略など"
                className="min-h-[70px]"
              />
            </div>
                ...
                {[1, 2, 3, 4, 5].map((num) => (
                  <div key={num} className="space-y-2">
                    ...
                    <div className="grid grid-cols-5 gap-2">
                      ...
                      <Input placeholder="u5b8c了予定日" type="date" />
                      <Input placeholder="u62c5当者・チーム" />
                      <Input placeholder="u6210果指標・KPI" />
                      <Input placeholder="u4e88算・リソース" />
                    </div>
                  </div>
                ))}
              </div>
