...
export default function NewPTUnified15MinInterviewSheetV5() {
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader className="bg-emerald-50">
          <CardTitle className="text-2xl">新人理学療法士（1年目）定期面談シート V5（15分版）</CardTitle>
          ...
          <Alert className="mt-3">
            ...
            <AlertDescription>
              15分の簡潔面談です。<strong>動機タイプ判定</strong>と新人理学療法士の基本的な適応状況を確認します。
            </AlertDescription>
          </Alert>
        </CardHeader>
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="評価の判断、治療プログラム立案、記録など"
                className="min-h-[60px]"
              />
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input 
                placeholder="例：ROM測定の精度向上、歩行分析の習得"
              />
            </div>
            ...
            <div className="space-y-2">
              <Label>必要なサポート</Label>
              <Textarea 
                placeholder="先輩からの技術指導、勉強会参加、症例検討など"
                className="min-h-[60px]"
              />
            </div>
          </div>
