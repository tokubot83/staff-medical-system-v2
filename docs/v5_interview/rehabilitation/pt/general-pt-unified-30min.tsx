...
export default function GeneralPTUnified30MinInterviewSheetV5() {
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader className="bg-emerald-50">
          <CardTitle className="text-2xl">一般理学療法士（2-3年目）定期面談シート V5（30分版）</CardTitle>
        ...
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b pb-2">1. 理学療法実践能力の評価（8分）</h3>
            
            <div className="bg-gray-50 p-4 rounded-lg space-y-3">
              <Label className="text-base font-semibold">PT技術・専門能力の評価</Label>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="担当患者数、疾患領域、症例の複雑度、達成度、貢献内容などを詳しく記入"
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="技術向上、症例理解、患者対応、チーム貢献など具体的に"
                className="min-h-[80px]"
              />
            </div>
          </div>
                ...
                <div className="space-y-3">
                  {typeSpecificQuestions.slice(0, 2).map((question, index) => (
                    <div key={index} className="space-y-2">
                      ...
                      <Textarea 
                        placeholder="理学療法士としての視点で詳しくお答えください"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="技術面、知識面、患者対応、記録、チーム連携などの具体的な課題"
                className="min-h-[80px]"
              />
            </div>
          ...
          <div className="space-y-4">
              ...
              <Alert className="bg-purple-50 border-purple-200">
                <AlertDescription>
                  ...
                  <div className="mt-1 text-sm">
                    {selectedMotivationType === 'growth' && '新技術研修参加、症例検討会発表、認定資格取得準備'}
                    {selectedMotivationType === 'recognition' && '技術向上の成果評価、院内外発表機会、表彰制度活用'}
                    {selectedMotivationType === 'stability' && '基本技術の確実な習得、段階的な症例担当、安定した指導体制'}
                    {selectedMotivationType === 'teamwork' && 'チーム医療での役割拡大、多職種連携強化、後輩サポート'}
                    {selectedMotivationType === 'efficiency' && '効率的治療プロトコール習得、時間管理研修、業務改善参加'}
                    {selectedMotivationType === 'compensation' && '昇進要件明示、資格取得支援、専門手当制度説明'}
                    {selectedMotivationType === 'creativity' && '独自アプローチ支援、研究活動参加、イノベーション奨励'}
                  </div>
                </AlertDescription>
              </Alert>
            )}
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="具体的で測定可能な目標を設定（例：特定疾患の評価技術習得、症例報告書作成など）"
                className="min-h-[60px]"
              />
            </div>
