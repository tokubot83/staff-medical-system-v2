...
export default function GeneralSTUnified30MinInterviewSheetV5() {
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader className="bg-indigo-50">
          <CardTitle className="text-2xl">一般言語聴覚士（2-3年目）定期面談シート V5（30分版）</CardTitle>
        ...
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input 
                placeholder="例：VF画像読影技術向上、失語症重症度判定の精度向上"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input 
                placeholder="例：摂食嚥下認定療法士資格取得準備、小児ST技術習得"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input 
                placeholder="例：専門分野での症例発表、後輩指導体制構築"
              />
            </div>
