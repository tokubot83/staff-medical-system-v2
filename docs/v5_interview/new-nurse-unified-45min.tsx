...
export default function NewNurseUnified45MinInterviewSheetV5() {
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader className="bg-amber-50">
          <CardTitle className="text-2xl">新人看護師（1年目）定期面談シート V5（45分版）</CardTitle>
          ...
          <Alert className="mt-3">
            ...
            <AlertDescription>
              45分の詳細面談です。<strong>動機タイプ判定</strong>を活用し、新人看護師の包括的な成長支援と職場適応の確認を行います。
            </AlertDescription>
          </Alert>
        </CardHeader>
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="space-y-4">
            ...
            {/* 動機タイプに基づく推奨アクション（新人向け） */}
            {selectedMotivationType && (
              <Alert className="bg-purple-50 border-purple-200">
                <AlertDescription>
                  <strong>動機タイプに基づく新人向け推奨アクション：</strong>
                  <div className="mt-2">
                    {selectedMotivationType === 'growth' && '段階的スキルアップ計画の策定、新規研修機会への優先参加'}
                    {selectedMotivationType === 'recognition' && '小さな成果の積極的評価、プリセプターからの定期的フィードバック'}
                    {selectedMotivationType === 'stability' && '詳細な業務マニュアルの提供、安定したプリセプター体制の確保'}
                    {selectedMotivationType === 'teamwork' && '同期との学習グループ形成、チーム活動への積極的参加'}
                    {selectedMotivationType === 'efficiency' && '効率的な業務手順の学習、時間管理スキルの向上支援'}
                    {selectedMotivationType === 'compensation' && '新人給与制度の説明、将来的なキャリアパスの明示'}
                    {selectedMotivationType === 'creativity' && '新人ならではの視点の活用、独自のアプローチの受容'}
                  </div>
                </AlertDescription>
              </Alert>
            )}
          ...
          <div className="space-y-4 border-t pt-4">
            ...
            <Textarea 
              placeholder="総合所見、強み・改善点、動機タイプを考慮した具体的なサポート計画、特記事項など詳細に記入"
