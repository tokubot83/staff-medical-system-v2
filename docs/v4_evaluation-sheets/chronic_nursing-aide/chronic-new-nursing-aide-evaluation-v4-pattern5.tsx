      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 療養生活支援の基礎習得と職場適応を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="technical" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  ...
                  <br />
                  新人看護補助者は基礎的な生活援助技術の習得と安全な実践を重視
                </p>
              </div>
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-4">
                  <div>
                    <Label className="text-sm font-medium">1. 基本的生活援助技術の習得</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:食事・排泄・入浴介助を完全習得 A:順調に習得 B:標準的 C:習得に遅れ D:大幅な遅れ
                    </p>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">2. 療養環境整備と感染対策</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:完璧な環境整備 A:丁寧な実践 B:基本的実践 C:改善必要 D:不十分
                    </p>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">3. 長期療養患者への接遇と関わり</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:心に寄り添う関わり A:丁寧で温かい B:標準的 C:改善必要 D:要指導
                    </p>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">4. 安全管理と報告・連絡・相談</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:確実な安全確認と報告 A:適切な実践 B:基本的実践 C:不十分 D:リスクあり
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <Textarea 
                  id="self-reflection" 
                  placeholder="技術習得で努力した点、患者様との関わりで心がけていること、今後の学習目標など"
            ...
            <TabsContent value="facility" className="space-y-6 mt-6">
              ...
              <div className="border rounded-lg overflow-hidden">
                <Table>
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      <TableCell>新人研修参加（ケア技術）</TableCell>
                    ...
                    <TableRow>
                      <TableCell>レクリエーション活動参加</TableCell>
                    ...
                    <TableRow>
                      <TableCell>環境整備活動（大掃除等）</TableCell>
                      <TableCell className="text-center">5pt/回</TableCell>
                      <TableCell className="text-center">
                    ...
                    <TableRow>
                      <TableCell>同期との学習会・情報共有</TableCell>
                      <TableCell className="text-center">3pt/回</TableCell>
                      <TableCell className="text-center">
                    ...
                    <TableRow className="bg-gray-50">
                      ...
                      <TableCell className="text-center font-bold text-lg">166pt</TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </div>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <h4 className="font-semibold mb-3">施設内相対評価（新人看護補助者間）</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div>
              ...
              {/* 職場適応評価 */}
              <div className="border rounded-lg p-4">
                <h4 className="font-semibold mb-3">療養チーム適応・協調性の定性評価</h4>
                <Textarea 
                  placeholder="チームメンバーとの関係性、協調性、積極性、療養環境への適応状況など"
            ...
            <TabsContent value="corporate" className="space-y-6 mt-6">
              ...
              <div className="border rounded-lg overflow-hidden">
                <Table>
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      <TableCell className="pl-8">法人新人研修（介護技術）</TableCell>
                    ...
                    <TableRow>
                      <TableCell className="pl-8">認知症ケア基礎研修</TableCell>
                      <TableCell className="text-center">8pt</TableCell>
                      <TableCell className="text-center">
                        <Input type="number" className="w-16 mx-auto" placeholder="1" />
                      </TableCell>
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                <h4 className="font-semibold mb-3">法人内相対評価（新人看護補助者全体）</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="corporate-rank">法人内順位（新人看護補助者）</Label>
                    <div className="flex gap-2 mt-1">
              ...
              <div className="border rounded-lg p-4">
                ...
                <Textarea 
                  placeholder="法人理念の理解度、日々のケアでの体現、法人文化への適応など"
                  className="min-h-[100px]"
                />
              </div>
            </TabsContent>
              ...
              <div>
                      ...
                      return (
                        <div>
                          <p className="text-sm mb-2">
                            ...
                            期待を大きく上回る成長。患者様への優しい関わりが際立つ
                          </p>
                          <ul className="text-sm list-disc list-inside">
                            <li>同期の中でロールモデルとなる存在</li>
                            <li>2年目に向けて、新人指導の補助役も期待</li>
                            <li>より高度な生活援助技術への挑戦を支援</li>
                          </ul>
                        </div>
                      );
                      ...
                      return (
                        <div>
                          <p className="text-sm mb-2">
                            ...
                            期待通りの成長。基礎的な生活援助技術が身についてきた
                          </p>
                          <ul className="text-sm list-disc list-inside">
                            <li>独り立ちに向けて着実に前進</li>
                            <li>患者様の個別性に応じたケアを学習中</li>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Textarea 
                      id="strengths" 
                      placeholder="生活援助技術で優れている点、患者様との関わり、チームへの良い影響など"
                      className="min-h-[100px]"
                    />
                  </div>
