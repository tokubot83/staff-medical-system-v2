...
export default function MidlevelCareAssistantEvaluationV4Pattern5() {
  // 評価項目の状態管理
  const [technicalScores, setTechnicalScores] = useState({
    superiorEval: { expertise: 0, leadership: 0, improvement: 0, mentoring: 0 },
    selfEval: { expertise: 0, leadership: 0, improvement: 0, mentoring: 0 }
  });
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老健 ミドルレベル介護士（4-10年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 中核的役割とチームリーダーシップを重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              <br />
              ミドルレベル介護士は施設運営の中核としての役割、チームリーダーシップ、業務改善への主導的関与を重点的に評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="basic" className="space-y-4 mt-6">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  <div>
                    ...
                    <select id="qualification" className="w-full border rounded-md px-3 py-2">
                      ...
                      <option value="kaigo-fukushishi">介護福祉士</option>
                      <option value="care-manager">介護支援専門員</option>
                      <option value="ninchishou">認知症ケア専門士</option>
                    </select>
                  </div>
                  <div>
                    <Label htmlFor="position">役職・担当</Label>
                    <Input type="text" id="position" placeholder="リーダー、主任代理等" />
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4 mt-4">
                  <div>
                  ...
                  <div>
                    ...
                    <Input type="text" id="team-size" placeholder="チーム○名、新人指導○名" />
                  </div>
                </div>
              </div>
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="evaluator1">1次評価者（介護主任・課長）</Label>
                    <Input type="text" id="evaluator1" />
                  </div>
                  <div>
                    <Label htmlFor="evaluator2">2次評価者（管理者・施設長）</Label>
            ...
            <TabsContent value="technical" className="space-y-6 mt-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:模範的な高度技術 A:確実な専門技術 B:安定した技術力 C:標準的技術 D:技術力不足
                    </p>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">2. チームリーダーシップと統率力</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:卓越したリーダーシップ A:効果的なチーム運営 B:適切なリーダー業務 C:リーダー力不足 D:要改善
                    </p>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">3. 業務改善・効率化の推進</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:革新的な改善実現 A:有効な改善提案・実施 B:改善への積極参加 C:改善意識低い D:現状維持志向
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:優秀な人材育成実績 A:効果的な指導実施 B:基本的な指導 C:指導力不足 D:育成困難
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <Label htmlFor="self-reflection">自己振り返り・リーダーとしての実践</Label>
                <Textarea 
                  id="self-reflection" 
                  placeholder="チームリーダーとしての実践、専門性向上の取り組み、後輩育成での工夫など"
            ...
            <TabsContent value="facility" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  ミドルレベル介護士は施設運営への参画、質向上への主導的役割を重視
                </p>
              </div>
              ...
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell>
                      <Input type="text" placeholder="フロア運営、シフト調整、チーム目標達成など" />
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableCell>
                      <Input type="text" placeholder="勉強会講師、OJTプログラム作成、実習指導など" />
                    </TableCell>
                  </TableRow>
                  <TableRow>
                  ...
                  <TableRow>
                    <TableCell className="font-medium">在宅復帰支援実績</TableCell>
                    <TableCell>
                      <Input type="number" className="w-20" placeholder="0" />
                    </TableCell>
                    <TableCell>
                      <Input type="text" placeholder="在宅復帰達成件数、家族指導、連携調整など" />
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">業務改善・効率化実績</TableCell>
                    <TableCell>
                      <Input type="number" className="w-20" placeholder="0" />
                    </TableCell>
                    <TableCell>
                      <Input type="text" placeholder="業務フロー改善、コスト削減、システム導入など" />
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
              ...
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell>
                      <Input type="text" placeholder="法人研修講師、事例発表、技術指導など" />
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">高度資格・専門性向上</TableCell>
                    <TableCell>
                      <Input type="number" className="w-20" placeholder="0" />
                    </TableCell>
                    <TableCell>
                      <Input type="text" placeholder="介護支援専門員取得、認知症専門士取得など" />
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">法人間連携・支援</TableCell>
                    <TableCell>
                      <Input type="number" className="w-20" placeholder="0" />
                    </TableCell>
                    <TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <Input type="text" placeholder="地域ケア会議参加、外部講師、専門職団体活動など" />
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">法人価値向上</TableCell>
                    <TableCell>
                      <Input type="number" className="w-20" placeholder="0" />
                    </TableCell>
                    <TableCell>
                      <Input type="text" placeholder="外部評価対応、実習指導、広報活動協力など" />
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg mb-6">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      {totalScore >= 90 ? '極めて優秀な中核スタッフ' : 
                       totalScore >= 80 ? '優秀なチームリーダー' : 
                       totalScore >= 70 ? '期待に応える中堅職員' : 
                       totalScore >= 60 ? '標準的な中堅職員' : '成長支援が必要な職員'}
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div>
                    ...
                    <Textarea 
                      id="strengths" 
                      placeholder="リーダーシップ、専門技術、チーム運営、改善提案力など"
                      className="min-h-[100px] mt-2"
                    />
                  </div>
                  <div>
                    ...
                    <Textarea 
                      id="challenges" 
                      placeholder="管理職準備、より高度な専門性、組織運営参画など"
                      className="min-h-[100px] mt-2"
                    />
                  </div>
                </div>
                ...
                <div className="mt-4">
                  ...
                  <Textarea 
                    ...
                    placeholder="ミドルレベル介護士としての実績、リーダーとしての成長、今後の期待など"
                    className="min-h-[100px] mt-2"
                  />
                </div>
              </div>
