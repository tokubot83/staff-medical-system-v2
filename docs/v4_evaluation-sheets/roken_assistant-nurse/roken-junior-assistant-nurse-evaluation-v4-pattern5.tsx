...
export default function RokenJuniorAssistantNurseEvaluationV4Pattern5() {
  ...
  const [technicalScores, setTechnicalScores] = useState({
    superiorEval: { 
      autonomy: 0,          // 自立した准看護師業務遂行
      mentoring: 0,         // 新人指導と経験の共有
      homeSupport: 0,       // 在宅復帰支援の実践参加
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            介護老人保健施設 ジュニア准看護師（2-3年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 自立した実践力と在宅復帰支援への参加を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              <br />
              2-3年目は複数サービスでの准看護師業務の実践力向上と在宅復帰への具体的な参加を評価します
            </AlertDescription>
          </Alert>
            ...
            <TabsContent value="technical" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  老健ジュニア准看護師として自立した実践力と指導力を360度評価で採点します
                  <br />
                        ...
                        <div className="space-y-2 mt-2">
                          <div className="flex items-start space-x-2">
                            ...
                            <Label htmlFor="autonomy-superior-s" className="font-normal">
                              <span className="font-semibold">S：</span> 全サービスで完全に自立し、効率的に准看護師業務を遂行
                            </Label>
                          </div>
                          <div className="flex items-start space-x-2">
                        ...
                        <div className="space-y-2 mt-2">
                          <div className="flex items-start space-x-2">
                            ...
                            <Label htmlFor="mentor-superior-s" className="font-normal">
                              <span className="font-semibold">S：</span> 優れた指導力を発揮し、新人准看護師の成長に大きく貢献
                            </Label>
                          </div>
                          <div className="flex items-start space-x-2">
                        ...
                        <div className="space-y-2 mt-2">
                          <div className="flex items-start space-x-2">
                            ...
                            <Label htmlFor="multi-superior-s" className="font-normal">
                              <span className="font-semibold">S：</span> 全サービスで卓越した実践力を発揮し、連携の要となる
                            </Label>
                          </div>
                          <div className="flex items-start space-x-2">
              ...
              <div>
                  ...
                  <Table>
                    ...
                    <TableBody>
                      <TableRow className={totalScore >= 90 ? 'bg-red-50' : ''}>
                        ...
                        <TableCell>次期リーダー候補（老健准看護師の中核人材）</TableCell>
                      </TableRow>
                ...
                <div className="space-y-4 mt-6">
                  <div>
                    ...
                    <Textarea 
                      id="strengths" 
                      placeholder="自立的な准看護師業務遂行、後輩指導力、在宅復帰支援の成果など"
                  ...
                  <div>
                    ...
                    <Textarea 
                      ...
                      placeholder="ジュニア准看護師としての成長度、今後の可能性、期待する役割など"
                      className="min-h-[100px]"
                    />
                  </div>
                </div>
