        ...
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              <br />
              師長看護師は慢性期病棟の経営管理能力と戦略的リーダーシップを重点的に評価します
            </AlertDescription>
          </Alert>
            ...
            <TabsContent value="technical" className="space-y-6 mt-6">
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('superiorEval', 'businessResults', value)}>
                  ...
                  <div>
                    ...
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('superiorEval', 'teamBuilding', value)}>
                      <div className="grid grid-cols-5 gap-2 mt-2">
                        {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                          <div key={grade} className="flex items-center space-x-1">
                  ...
                  <div>
                    ...
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('superiorEval', 'facilityContrib', value)}>
                      <div className="grid grid-cols-5 gap-2 mt-2">
                        {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                          <div key={grade} className="flex items-center space-x-1">
                  ...
                  <div>
                    ...
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('superiorEval', 'strategic', value)}>
                      <div className="grid grid-cols-5 gap-2 mt-2">
                        {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                          <div key={grade} className="flex items-center space-x-1">
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-4">
                  <div>
                    <Label className="text-sm font-medium">1. 慢性期病棟の経営成果</Label>
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('selfEval', 'businessResults', value)}>
                      <div className="grid grid-cols-5 gap-2 mt-2">
                        {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                          <div key={grade} className="flex items-center space-x-1">
                  ...
                  <div>
                    <Label className="text-sm font-medium">2. 慢性期ケアチームの組織力</Label>
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('selfEval', 'teamBuilding', value)}>
                      <div className="grid grid-cols-5 gap-2 mt-2">
                        {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                          <div key={grade} className="flex items-center space-x-1">
                  ...
                  <div>
                    <Label className="text-sm font-medium">3. 施設経営への貢献</Label>
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('selfEval', 'facilityContrib', value)}>
                      <div className="grid grid-cols-5 gap-2 mt-2">
                        {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                          <div key={grade} className="flex items-center space-x-1">
                  ...
                  <div>
                    <Label className="text-sm font-medium">4. 戦略的リーダーシップ</Label>
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('selfEval', 'strategic', value)}>
                      <div className="grid grid-cols-5 gap-2 mt-2">
                        {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                          <div key={grade} className="flex items-center space-x-1">
                ...
                <div className="mt-4">
                  ...
                  <Textarea 
                    id="self-reflection" 
                    placeholder="師長看護師としての病棟経営、組織運営での成果、戦略的な取り組みなど"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
