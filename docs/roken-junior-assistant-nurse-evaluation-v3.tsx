...
export default function RokenJuniorAssistantNurseEvaluationV3() {
  return (
    <div className="container mx-auto py-10 px-4 max-w-5xl">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            介護老人保健施設 2・3年目准看護師 人事評価シート
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            自立した実践力と専門性向上を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              准看護師として自立した業務遂行と、老健ケアへの積極的な貢献を評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="facility" className="space-y-6 mt-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h4 className="font-semibold mb-3">3. チーム活動への貢献</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="team-contribution-s" />
                        <Label htmlFor="team-contribution-s" className="font-normal">
                          <span className="font-semibold">S：</span> チーム活動を主導し、業務改善を実現
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="a" id="team-contribution-a" />
                        <Label htmlFor="team-contribution-a" className="font-normal">
                          <span className="font-semibold">A：</span> 積極的にチーム活動に参加し、貢献
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="b" id="team-contribution-b" />
                        <Label htmlFor="team-contribution-b" className="font-normal">
                          <span className="font-semibold">B：</span> 与えられた役割を適切に果たす
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="c" id="team-contribution-c" />
                        <Label htmlFor="team-contribution-c" className="font-normal">
                          <span className="font-semibold">C：</span> チーム活動への参加が限定的
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="d" id="team-contribution-d" />
                        <Label htmlFor="team-contribution-d" className="font-normal">
                          <span className="font-semibold">D：</span> チーム活動への貢献がない
                        </Label>
                      </div>
                    </div>
                  </RadioGroup>
                ...
                <div>
                  ...
                  <Textarea 
                    id="facility-comment" 
                    placeholder="自立した業務遂行の例、新人指導での成果、チーム活動での貢献など"
            ...
            <TabsContent value="corporate" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  准看護師としての実践力と在宅復帰支援への理解を評価
                </p>
              </div>

              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold mb-3">1. 准看護実践の質</h4>
                  <RadioGroup>
                    <div className="space-y-2">
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="s" id="practice-quality-s" />
                        <Label htmlFor="practice-quality-s" className="font-normal">
                          <span className="font-semibold">S：</span> 高度な実践により、利用者の状態改善に顕著な成果
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="a" id="practice-quality-a" />
                        <Label htmlFor="practice-quality-a" className="font-normal">
                          <span className="font-semibold">A：</span> 確実な実践で、利用者の満足度向上に貢献
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="b" id="practice-quality-b" />
                        <Label htmlFor="practice-quality-b" className="font-normal">
                          <span className="font-semibold">B：</span> 標準的な准看護業務を安全に実践
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="c" id="practice-quality-c" />
                        <Label htmlFor="practice-quality-c" className="font-normal">
                          <span className="font-semibold">C：</span> 実践の質に改善の余地がある
                        </Label>
                      </div>
                      <div className="flex items-start space-x-2">
                        <RadioGroupItem value="d" id="practice-quality-d" />
                        <Label htmlFor="practice-quality-d" className="font-normal">
                          <span className="font-semibold">D：</span> 基本的な実践に課題があり、指導が必要
                        </Label>
                      </div>
                    </div>
                  </RadioGroup>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="優れた実践例、在宅復帰支援での取り組み、多職種連携での成果など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
            ...
            <TabsContent value="development" className="space-y-6 mt-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea 
                    id="growth-areas" 
                    placeholder="リーダーシップ開発、専門分野の確立、在宅復帰支援の深化など"
                    className="min-h-[80px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="next-goals" 
                    placeholder="チームリーダー役割、新人教育担当、専門分野での成果など"
                    className="min-h-[100px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="training-plan" 
                    placeholder="リーダーシップ研修、専門分野研修、看護師資格取得支援など"
                    className="min-h-[100px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="career-path" 
                    placeholder="4年目以降の役割、専門性の深化、看護師へのステップアップなど"
                    className="min-h-[80px]"
                  />
                </div>
