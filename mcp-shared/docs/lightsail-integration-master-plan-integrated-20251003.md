...
| L3 | 主任看護師 | 自分の情報のみ | STAFF | ✅ 実装済み |
| L4 | 課長 | 自分の情報のみ | STAFF | ✅ 実装済み |
| L5 | 戦略企画部門員 | 予約管理・調整 | TEAM_LEADER | ✅ 実装済み |
| L6 | キャリア支援部門員 | 面談実施・記録作成 | TEAM_LEADER | ✅ 実装済み |
| L7 | 看護部長 / 統括主任 | 部門職員の情報閲覧 | DEPARTMENT_HEAD | ✅ 実装済み（医療チーム承認） |
| L8 | 統括管理部門長 | 全職員情報閲覧 | DEPARTMENT_HEAD | ✅ 実装済み |
| L9 | 副院長 | システム全体管理 | EXECUTIVE | ✅ 実装済み |
| L10 | 院長 | システム全体管理 | EXECUTIVE | ✅ 実装済み |

**重要**: 立神リハビリテーション温泉病院の「統括主任」はレベル7（医療チーム承認済み）
