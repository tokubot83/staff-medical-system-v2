...
type TechnicalScoreCategory = 'careSkills' | 'safety' | 'communication' | 'leadership';
type EvaluatorType = 'superiorEval' | 'selfEval';

export default function RokenJuniorCertifiedCareWorkerEvaluationV4Pattern5() {
  const [technicalScores, setTechnicalScores] = useState<{
    [key in EvaluatorType]: {
      [key in TechnicalScoreCategory]: number;
    };
  }>({
    superiorEval: { careSkills: 0, safety: 0, communication: 0, leadership: 0 },
    selfEval: { careSkills: 0, safety: 0, communication: 0, leadership: 0 }
  });
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老健 一般介護福祉士（2-3年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            介護老人保健施設における一般介護福祉士（国家資格保有者）の評価
          </p>
        </CardHeader>
        <CardContent>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="employeeCode" placeholder="例: CW002" />
                    </div>
                    <div>
                      <Label htmlFor="employeeName">氏名</Label>
                      <Input id="employeeName" placeholder="佐藤 花子" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      <Input id="position" placeholder="一般介護福祉士" defaultValue="一般介護福祉士" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <Tabs defaultValue="superior" className="w-full">
                      ...
                      <TabsContent value="superior" className="space-y-4">
                        <div className="space-y-4">
                          <div>
                            <Label className="text-base font-semibold">1. 専門的介護技術・アセスメント</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              自立した介護実践、的確なアセスメント、介護過程の展開
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">3. 多職種連携・チームワーク</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              看護師との協働、リハビリ職との連携、記録・申し送りの質
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">4. 在宅復帰支援・初歩的指導</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              在宅復帰への取り組み、新人職員への基本的指導
                            </p>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        この評価シートは、老健における一般介護福祉士の成長と貢献度を公正に評価し、
                        今後のキャリア開発を明確にすることを目的としています。
                      </p>
                    </div>
                    <div>
                      <h3 className="font-semibold mb-2">一般介護福祉士の期待役割</h3>
                      <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                        <li>専門的知識に基づいた自立的な介護実践</li>
                        <li>的確なアセスメントと介護過程の展開</li>
                        <li>無資格職員への基本的な指導・サポート</li>
                        <li>多職種チームの中核的メンバーとしての役割</li>
                        <li>在宅復帰支援への積極的参画</li>
                      </ul>
                    </div>
                  </div>
