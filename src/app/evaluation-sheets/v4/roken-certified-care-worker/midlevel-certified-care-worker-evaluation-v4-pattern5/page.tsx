...
type TechnicalScoreCategory = 'careSkills' | 'leadership' | 'guidance' | 'innovation';
type EvaluatorType = 'superiorEval' | 'selfEval';

export default function RokenMidlevelCertifiedCareWorkerEvaluationV4Pattern5() {
  const [technicalScores, setTechnicalScores] = useState<{
    [key in EvaluatorType]: {
      [key in TechnicalScoreCategory]: number;
    };
  }>({
    superiorEval: { careSkills: 0, leadership: 0, guidance: 0, innovation: 0 },
    selfEval: { careSkills: 0, leadership: 0, guidance: 0, innovation: 0 }
  });
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老健 中堅介護福祉士（4-10年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            介護老人保健施設における中堅介護福祉士（国家資格保有者）の評価
          </p>
        </CardHeader>
        <CardContent>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="employeeCode" placeholder="例: CW003" />
                    </div>
                    <div>
                      <Label htmlFor="employeeName">氏名</Label>
                      <Input id="employeeName" placeholder="高橋 太郎" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      <Input id="position" placeholder="中堅介護福祉士" defaultValue="中堅介護福祉士" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      <Input id="licenseNumber" placeholder="第A-234567号" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <Tabs defaultValue="superior" className="w-full">
                      ...
                      <TabsContent value="superior" className="space-y-4">
                        <div className="space-y-4">
                          <div>
                            <Label className="text-base font-semibold">1. 高度な介護技術・専門性</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              複雑な介護技術の習得、専門的判断力、困難事例への対応
                            </p>
                            <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('superiorEval', 'careSkills', value as keyof typeof gradeToScore)}>
                              <div className="flex space-x-4">
                                <div className="flex items-center">
                                  <RadioGroupItem value="S" id="superior-care-s" />
                                  <Label htmlFor="superior-care-s" className="ml-2">S(優秀)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="A" id="superior-care-a" />
                                  <Label htmlFor="superior-care-a" className="ml-2">A(良好)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="B" id="superior-care-b" />
                                  <Label htmlFor="superior-care-b" className="ml-2">B(標準)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="C" id="superior-care-c" />
                                  <Label htmlFor="superior-care-c" className="ml-2">C(要努力)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="D" id="superior-care-d" />
                                  <Label htmlFor="superior-care-d" className="ml-2">D(要改善)</Label>
                                </div>
                              </div>
                            </RadioGroup>
                          </div>
                          ...
                          <div>
                            <Label className="text-base font-semibold">2. リーダーシップ・チーム調整</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              チームをまとめる力、業務調整、問題解決への取り組み
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">3. 指導力・人材育成</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              後輩・新人への指導、技術指導、成長支援
                            </p>
                            <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('superiorEval', 'guidance', value as keyof typeof gradeToScore)}>
                              <div className="flex space-x-4">
                                <div className="flex items-center">
                                  <RadioGroupItem value="S" id="superior-guidance-s" />
                                  <Label htmlFor="superior-guidance-s" className="ml-2">S(優秀)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="A" id="superior-guidance-a" />
                                  <Label htmlFor="superior-guidance-a" className="ml-2">A(良好)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="B" id="superior-guidance-b" />
                                  <Label htmlFor="superior-guidance-b" className="ml-2">B(標準)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="C" id="superior-guidance-c" />
                                  <Label htmlFor="superior-guidance-c" className="ml-2">C(要努力)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="D" id="superior-guidance-d" />
                                  <Label htmlFor="superior-guidance-d" className="ml-2">D(要改善)</Label>
                                </div>
                              </div>
                            </RadioGroup>
                          </div>
                          ...
                          <div>
                            <Label className="text-base font-semibold">4. 改善提案・イノベーション</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              業務改善への提案、新しい取り組み、効率化への貢献
                            </p>
                            ...
                            <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('selfEval', 'careSkills', value as keyof typeof gradeToScore)}>
                              <div className="flex space-x-4">
                                <div className="flex items-center">
                                  ...
                                  <Label htmlFor="self-care-s" className="ml-2">S(優秀)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="A" id="self-care-a" />
                                  <Label htmlFor="self-care-a" className="ml-2">A(良好)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="B" id="self-care-b" />
                                  <Label htmlFor="self-care-b" className="ml-2">B(標準)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="C" id="self-care-c" />
                                  <Label htmlFor="self-care-c" className="ml-2">C(要努力)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="D" id="self-care-d" />
                                  <Label htmlFor="self-care-d" className="ml-2">D(要改善)</Label>
                                </div>
                              </div>
                            </RadioGroup>
                          </div>
                            ...
                            <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('selfEval', 'guidance', value as keyof typeof gradeToScore)}>
                              <div className="flex space-x-4">
                                <div className="flex items-center">
                                  ...
                                  <Label htmlFor="self-guidance-s" className="ml-2">S(優秀)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="A" id="self-guidance-a" />
                                  <Label htmlFor="self-guidance-a" className="ml-2">A(良好)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="B" id="self-guidance-b" />
                                  <Label htmlFor="self-guidance-b" className="ml-2">B(標準)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="C" id="self-guidance-c" />
                                  <Label htmlFor="self-guidance-c" className="ml-2">C(要努力)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="D" id="self-guidance-d" />
                                  <Label htmlFor="self-guidance-d" className="ml-2">D(要改善)</Label>
                                </div>
                              </div>
                            </RadioGroup>
                          </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        この評価シートは、老健における中堅介護福祉士の成長と貢献度を公正に評価し、
                        今後のキャリア開発を明確にすることを目的としています。
                      </p>
                    </div>
                    <div>
                      <h3 className="font-semibold mb-2">中堅介護福祉士の期待役割</h3>
                      <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                        <li>高度な介護技術の習得と実践</li>
                        <li>チームのリーダーとして業務調整・問題解決</li>
                        <li>後輩・新人職員への指導と育成</li>
                        <li>業務改善提案と効率化への貢献</li>
                        <li>多職種連携の中心的役割</li>
                      </ul>
                    </div>
                  </div>
