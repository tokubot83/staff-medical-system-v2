...
export default function RokenNewCertifiedCareWorkerEvaluationV4Pattern5() {
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-center text-gray-600 mt-2">
            介護老人保健施設における新人介護福祉士（国家資格保有者）の評価
          </p>
        </CardHeader>
        <CardContent>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="employeeCode" placeholder="例: CW001" />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input id="position" placeholder="新人介護福祉士" defaultValue="新人介護福祉士" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      <Input id="licenseNumber" placeholder="第A-123456号" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <Tabs defaultValue="superior" className="w-full">
                      ...
                      <TabsContent value="superior" className="space-y-4">
                        <div className="space-y-4">
                          <div>
                            <Label className="text-base font-semibold">1. 介護技術・専門知識</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              基本的な介護技術、介護保険制度の理解、専門的アセスメント能力
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">2. 安全管理・リスクマネジメント</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              転倒・転落予防、感染予防、事故防止への取り組み
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">3. コミュニケーション・チームケア</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              利用者・家族とのコミュニケーション、多職種連携、記録・報告
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">4. 在宅復帰支援・学習意欲</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              在宅復帰に向けた支援、自己研鑽、資格を活かした実践
                            </p>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        この評価シートは、老健における新人介護福祉士の成長と貢献度を公正に評価し、
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                        ...
                        <li><strong>A（良好）</strong>：期待を上回る。自立して業務遂行可能</li>
                        <li><strong>B（標準）</strong>：期待通り。基本的な業務は遂行可能</li>
                        <li><strong>C（要努力）</strong>：期待をやや下回る。一部支援が必要</li>
                        <li><strong>D（要改善）</strong>：期待を大きく下回る。継続的な指導が必要</li>
                      </ul>
                    </div>
                    <div>
                      <h3 className="font-semibold mb-2">介護福祉士（国家資格）の特性</h3>
                      <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                        <li>専門的知識に基づいた介護実践</li>
                        <li>介護過程の展開とケアプラン作成への参画</li>
                        <li>無資格介護職員への指導・教育的役割</li>
                        <li>認知症ケアの専門的実践</li>
                        <li>在宅復帰支援における中心的役割</li>
                        <li>介護福祉士配置加算への貢献</li>
                      </ul>
                    </div>
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        ...
                        チームケアへの貢献、資格を活かした専門的実践などを総合的に評価し、
                        相対的な順位として表現します。
                      </p>
                    </div>
                  </div>
