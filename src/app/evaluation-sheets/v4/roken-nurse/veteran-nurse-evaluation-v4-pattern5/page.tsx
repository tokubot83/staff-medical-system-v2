...
type TechnicalScoreCategory = 'leadership' | 'expertise' | 'education' | 'innovation';
...
export default function RokenVeteranNurseEvaluationV4Pattern5() {
  const [technicalScores, setTechnicalScores] = useState<{
    ...
    superiorEval: { leadership: 0, expertise: 0, education: 0, innovation: 0 },
    selfEval: { leadership: 0, expertise: 0, education: 0, innovation: 0 }
  });
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老健 ベテラン看護師（11年以上） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            介護老人保健施設におけるベテラン看護師の評価
          </p>
        </CardHeader>
        <CardContent>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="employeeCode" placeholder="例: RN004" />
                    </div>
                    <div>
                      <Label htmlFor="employeeName">氏名</Label>
                      <Input id="employeeName" placeholder="田中 美恵" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      <Input id="position" placeholder="ベテラン看護師" defaultValue="ベテラン看護師" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <Tabs defaultValue="superior" className="w-full">
                      ...
                      <TabsContent value="superior" className="space-y-4">
                        <div className="space-y-4">
                          <div>
                            <Label className="text-base font-semibold">1. 高度なリーダーシップ</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              施設全体の看護の質向上、他職種との調整、危機管理能力
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">2. 専門的実践・指導力</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              高度な看護実践、根拠に基づくケア、専門技術の指導
                            </p>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        この評価シートは、老健におけるベテラン看護師の成長と貢献度を公正に評価し、
                        今後のキャリア開発を明確にすることを目的としています。
                      </p>
                    </div>
                    <div>
                      <h3 className="font-semibold mb-2">ベテラン看護師の期待役割</h3>
                      <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                        <li>施設全体の看護の質向上をリードする</li>
                        <li>高度な専門技術と判断力を発揮する</li>
                        <li>後輩の育成と指導を積極的に行う</li>
                        <li>業務改善と変革をドライブする</li>
                        <li>組織運営に参画し、意思決定に貢献する</li>
                      </ul>
                    </div>
                  </div>
                </CardContent>
