    ...
    <div className="max-w-7xl mx-auto p-5">
     <div className="mb-12">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
       <Link href="/reports" className="bg-gray-50 rounded-xl p-5 text-center shadow-md border-t-4 border-green-500 hover:shadow-lg transition-shadow cursor-pointer">
      ...
      <div className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-full">総職員数</div>
       ...
       <Link href="/reports" className="bg-gray-50 rounded-xl p-5 text-center shadow-md border-t-4 border-blue-500 hover:shadow-lg transition-shadow cursor-pointer">
      ...
      <div className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full">総合満足度</div>
       ...
       <Link href="/reports" className="bg-gray-50 rounded-xl p-5 text-center shadow-md border-t-4 border-purple-500 hover:shadow-lg transition-shadow cursor-pointer">
      ...
      <div className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full">研修受講率</div>
       ...
       <Link href="/reports" className="bg-gray-50 rounded-xl p-5 text-center shadow-md border-t-4 border-yellow-500 hover:shadow-lg transition-shadow cursor-pointer">
      ...
      <div className="text-xs bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full">要注意職員</div>
       ...
       <Link href="/reports" className="bg-gray-50 rounded-xl p-5 text-center shadow-md border-t-4 border-red-500 hover:shadow-lg transition-shadow cursor-pointer">
