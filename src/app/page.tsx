      ...
      <div className="max-w-7xl mx-auto px-4">
       <div className="flex items-center h-12">
        <div className="flex space-x-1">
         ...
         <Link href="/hr-strategy" className="hover:bg-gray-700 px-4 py-3 text-sm font-medium transition-colors border-b-3 border-transparent hover:border-blue-400">
          人材戦略
         </Link>
         ...
         <Link href="/reports/home" className="hover:bg-gray-700 px-4 py-3 text-sm font-medium transition-colors border-b-3 border-transparent hover:border-blue-400">
          レポート
         </Link>
        </div>
       </div>
