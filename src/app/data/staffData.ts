...
export const staffDatabase: Record<string, StaffDetail> = {
  'NS-2025-001': {
    ...
    skills: [
      ...
      { name: '組織的役割遂行能力', level: 3, category: 'JNAラダー' },
      { name: '自己教育・研究能力', level: 3, category: 'JNAラダー' },
      { name: '倫理的実践能力', level: 4, category: 'JNAラダー' },
      { name: '基礎看護技術', level: 5, category: '看護技術' },
      { name: '与薬管理', level: 4, category: '看護技術' },
      { name: '急変対応', level: 3, category: '看護技術' },
      { name: 'チーム医療', level: 4, category: '連携' },
      { name: '患者指導', level: 4, category: 'コミュニケーション' },
      { name: '記録・報告', level: 5, category: '管理' },
    ],
    trainingHistory: [
      { name: 'BLS研修', date: '2024年11月', category: '救急', hours: 4, evaluation: '合格', certificate: true },
      { name: '医療安全研修', date: '2024年10月', category: '安全管理', hours: 3, evaluation: '優秀', certificate: true },
      { name: '感染対策研修', date: '2024年9月', category: '感染管理', hours: 3, evaluation: '良好', certificate: true },
      { name: '褥創ケア研修', date: '2024年8月', category: '専門技術', hours: 6, evaluation: '優秀', certificate: true },
      { name: '認知症ケア基礎研修', date: '2024年7月', category: '専門技術', hours: 8, evaluation: '良好', certificate: true },
      { name: '看護倫理研修', date: '2024年6月', category: '倫理', hours: 4, evaluation: '優秀', certificate: true },
      { name: 'がん看護基礎研修', date: '2024年5月', category: '専門技術', hours: 12, evaluation: '進行中', certificate: false },
  ...
  'NS-2024-012': {
    ...
    tenure: '9ヶ月',
    age: 23,
    birthDate: '2001年12月5日',
    evaluation: 'B',
    evaluationPeriod: '2024年下期',
    nextMeeting: '2025年1月18日',
    healthStatus: '注意',
    stressIndex: 68,
    engagement: 75,
    overtime: 25,
    ...
    email: 'kobayashi.sakura@hospital.jp',
    phone: '080-1111-2222',
    ...
    skills: [
      ...
      { name: '組織的役割遂行能力', level: 1, category: 'JNAラダー' },
      { name: '自己教育・研究能力', level: 1, category: 'JNAラダー' },
      { name: '倫理的実践能力', level: 2, category: 'JNAラダー' },
      { name: '基礎看護技術', level: 2, category: '看護技術' },
      { name: '与薬管理', level: 2, category: '看護技術' },
      { name: '急変対応', level: 1, category: '看護技術' },
      { name: 'チーム医療', level: 2, category: '連携' },
      { name: '患者指導', level: 2, category: 'コミュニケーション' },
      { name: '記録・報告', level: 3, category: '管理' },
    ],
    trainingHistory: [
      { name: '新人看護師研修', date: '2024年4月', category: '基礎研修', hours: 160, evaluation: '修了', certificate: true },
      { name: '医療安全基礎研修', date: '2024年5月', category: '安全管理', hours: 8, evaluation: '良好', certificate: true },
      { name: '感染対策基礎研修', date: '2024年6月', category: '感染管理', hours: 6, evaluation: '良好', certificate: true },
      { name: '褥創予防研修', date: '2024年7月', category: '専門技術', hours: 4, evaluation: '努力要', certificate: false },
      { name: 'BLS研修', date: '2024年8月', category: '救急', hours: 4, evaluation: '再受講中', certificate: false },
  ...
  'NS-2015-008': {
    ...
    skills: [
      ...
      { name: '組織的役割遂行能力', level: 5, category: 'JNAラダー' },
      { name: '自己教育・研究能力', level: 5, category: 'JNAラダー' },
      { name: '倫理的実践能力', level: 5, category: 'JNAラダー' },
      { name: '緩和ケア', level: 5, category: '専門技術' },
      { name: '疼痛管理', level: 5, category: '専門技術' },
      { name: '家族ケア', level: 5, category: '専門技術' },
      { name: '後輩指導', level: 5, category: '管理' },
      { name: '多職種連携', level: 5, category: '連携' },
      { name: '研究・学会発表', level: 4, category: '研究' },
    ],
    trainingHistory: [
      { name: '緩和ケア認定看護師更新研修', date: '2024年11月', category: '専門資格', hours: 40, evaluation: '優秀', certificate: true },
      { name: 'がん看護エキスパート研修', date: '2024年9月', category: '専門技術', hours: 24, evaluation: '優秀', certificate: true },
      { name: 'コミュニケーション指導者研修', date: '2024年7月', category: '指導', hours: 16, evaluation: '優秀', certificate: true },
      { name: '看護研究発表会', date: '2024年6月', category: '研究', hours: 8, evaluation: '最優秀賞', certificate: true },
  ...
  'NS-2018-035': {
    ...
    position: '看護師',
    department: '外来',
    employeeId: 'NS-2018-035',
    joinDate: '2018年4月1日',
    tenure: '6年9ヶ月',
    age: 32,
    birthDate: '1992年11月15日',
    evaluation: 'C',
    evaluationPeriod: '2024年下期',
    nextMeeting: '2025年1月17日 9:00',
    healthStatus: '要注意',
    stressIndex: 85,
    engagement: 45,
    overtime: 32,
    ...
    email: 'nakamura.keiko@hospital.jp',
    phone: '080-7777-8888',
    ...
    skills: [
      ...
      { name: '組織的役割遂行能力', level: 2, category: 'JNAラダー' },
      { name: '自己教育・研究能力', level: 2, category: 'JNAラダー' },
      { name: '倫理的実践能力', level: 3, category: 'JNAラダー' },
      { name: '外来看護', level: 4, category: '看護技術' },
      { name: 'トリアージ', level: 3, category: '看護技術' },
      { name: '処置介助', level: 4, category: '看護技術' },
      { name: '患者対応', level: 3, category: 'コミュニケーション' },
      { name: '多職種連携', level: 2, category: '連携' },
    ],
    trainingHistory: [
      { name: '医療安全研修', date: '2024年10月', category: '安全管理', hours: 3, evaluation: '欠席', certificate: false },
      { name: '感染対策研修', date: '2024年9月', category: '感染管理', hours: 3, evaluation: '欠席', certificate: false },
      { name: 'BLS更新研修', date: '2024年8月', category: '救急', hours: 4, evaluation: '合格', certificate: true },
      { name: '外来看護研修', date: '2024年6月', category: '専門技術', hours: 6, evaluation: '良好', certificate: true },
    ],
    assignmentHistory: [
  ...
  'NS-2017-022': {
    ...
    tenure: '7年9ヶ月',
    age: 34,
    birthDate: '1990年8月25日',
    evaluation: 'B',
    evaluationPeriod: '2024年下期',
    nextMeeting: '2025年1月22日',
    healthStatus: '良好',
    stressIndex: 52,
    engagement: 80,
    overtime: 5,
    ...
    email: 'watanabe.mai@hospital.jp',
    phone: '080-2222-3333',
    ...
    skills: [
      ...
      { name: '自己教育・研究能力', level: 2, category: 'JNAラダー' },
      { name: '倫理的実践能力', level: 4, category: 'JNAラダー' },
      { name: '小児看護', level: 4, category: '看護技術' },
      { name: '家族ケア', level: 4, category: '看護技術' },
      { name: 'プレパレーション', level: 3, category: '専門技術' },
      { name: '発達支援', level: 3, category: '専門技術' },
    ],
    trainingHistory: [
      { name: '復職支援研修', date: '2024年7月', category: '基礎研修', hours: 16, evaluation: '修了', certificate: true },
      { name: '小児救急研修', date: '2024年9月', category: '救急', hours: 8, evaluation: '良好', certificate: true },
