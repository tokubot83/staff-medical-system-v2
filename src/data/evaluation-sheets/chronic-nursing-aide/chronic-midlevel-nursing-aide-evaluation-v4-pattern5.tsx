      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            【慢性期医療】中堅看護補助者（4-7年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 専門的な慢性期ケアの実践とチームリーダーシップを重視
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              <br />
              慢性期医療における中堅看護補助者は、高度な療養支援技術とチーム指導・業務改善のリーダーシップを重点的に評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="technical" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  ...
                  <br />
                  中堅看護補助者は専門的な慢性期ケアの実践と後輩指導・チーム運営を重視
                </p>
              </div>
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-4">
                  <div>
                    <Label className="text-sm font-medium">1. 高度な慢性期療養支援技術の実践</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      ...
                      <br />
                      （重度褥瘡ケア、複雑な認知症行動への対応、終末期ケアの実践、多職種連携での役割等）
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      ...
                      <br />
                      （難病ケアの理解、緩和ケアの知識、リハビリテーション支援、感染対策の実践等）
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      ...
                      <br />
                      （新人・初級者の育成成果、チーム調整、業務配分、問題解決の主導等）
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      ...
                      <br />
                      （インシデント分析と改善提案、マニュアル作成、安全文化の醸成、教育プログラム開発等）
                    </p>
                  </div>
                </div>
            ...
            <TabsContent value="facility" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  ...
                  <br />
                  中堅看護補助者として病棟運営への積極的関与とチーム牽引を重視
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="border rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex items-start">
                      <span className="font-medium mr-2">5.</span>
                      <span>介護福祉士資格取得・専門研修修了（該当者）</span>
                    </div>
                  </div>
                </div>
            ...
            <TabsContent value="summary" className="space-y-6 mt-6">
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="strengths">特に優れている点（中堅看護補助者としての観点から）</Label>
                    <Textarea 
                      id="strengths" 
                  ...
                  <div>
                    ...
                    <Textarea 
                      id="improvements" 
                      placeholder="更なる専門性向上、管理能力開発、資格取得への挑戦など"
                      className="min-h-[80px]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea 
                      id="development-plan" 
                      placeholder="ベテラン看護補助者に向けた目標、必要な研修、キャリア開発支援など"
                      className="min-h-[100px]"
                    />
                  </div>
                  ...
                  <div className="border-t pt-4">
                    ...
                    <Textarea 
                      id="final-comment" 
                      placeholder="中堅看護補助者としての成熟度、慢性期医療での影響力、将来の可能性など"
