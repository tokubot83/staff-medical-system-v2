      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            【慢性期医療】初級看護補助者（2-3年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 長期療養ケアの自立的実践と後輩指導の基礎を重視
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              <br />
              慢性期医療における初級看護補助者は、療養生活支援の自立的実施と新人指導の開始を重点的に評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="basic" className="space-y-4 mt-6">
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  ...
                  <div>
                    <Label htmlFor="guidance-role">指導役割</Label>
                    <Input type="text" id="guidance-role" placeholder="新人補助者指導担当等" />
                  </div>
                </div>
              </div>
            ...
            <TabsContent value="technical" className="space-y-6 mt-6">
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-4">
                  <div>
                    <Label className="text-sm font-medium">1. 慢性期療養生活援助の自立的実践</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:自立的で確実な実践 A:ほぼ自立的実践 B:標準的実践 C:指導下での実践 D:要継続指導
                      <br />
                      （個別性を踏まえた食事・排泄・入浴介助、体位変換、褥瘡予防ケア、レクリエーション支援等）
                    </p>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">2. 慢性期患者の特性理解と対応</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      ...
                      <br />
                      （認知症の周辺症状への対応、廃用症候群の理解、長期臥床患者のケア、終末期の基礎的理解等）
                    </p>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">3. 長期療養患者・家族とのコミュニケーション</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:信頼関係構築 A:良好な関係 B:適切な対応 C:改善必要 D:要指導
                      <br />
                      （傾聴技術、共感的態度、家族への情報提供、QOL向上への配慮等）
                    </p>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">4. 安全管理と新人指導の基礎</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:積極的な実践 A:確実な実践 B:基本的実践 C:不十分 D:要改善
                      <br />
                      （転倒・転落予防、誤嚥予防、感染予防、新人への基本技術指導等）
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-4">
                  ...
                  <Textarea 
                    id="superior-comment" 
                    placeholder="自立的な業務遂行状況、慢性期ケアの理解度、新人指導の様子など具体的に記載"
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="mt-4">
                  ...
                  <Textarea 
                    id="self-reflection" 
                    placeholder="自立的な業務での工夫、患者ケアでの成長、新人指導での学びなど"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
            ...
            <TabsContent value="facility" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  慢性期病棟でのチーム貢献・新人指導・業務改善を評価
                  <br />
                  初級看護補助者としての役割発揮と積極的な組織参加を重視
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="border rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex items-start">
                      ...
                      <span>新人看護補助者への指導・サポート</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">2.</span>
                      <span>慢性期ケアの業務改善提案</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">3.</span>
                      <span>チーム内での協働と調整</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">4.</span>
                      <span>療養環境整備への積極的関与</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">5.</span>
                      <span>病棟行事・レクリエーション活動への参画</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="新人指導の実績、業務改善の成果、チーム貢献の具体例など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="border rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex items-start">
                      <span className="font-medium mr-2">2.</span>
                      <span>患者満足度・QOL向上への貢献</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">3.</span>
                      <span>法人研修への積極的参加と学習</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">4.</span>
                      <span>他部署との連携・協力</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">5.</span>
                      <span>介護福祉士資格取得への取り組み（該当者）</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="慢性期医療の質向上への取り組み、患者評価、法人活動への参加など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
            ...
            <TabsContent value="summary" className="space-y-6 mt-6">
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="strengths">特に優れている点（初級看護補助者としての観点から）</Label>
                    <Textarea 
                      id="strengths" 
                      placeholder="自立的な業務遂行、患者ケアの質、新人指導力など"
                  ...
                  <div>
                    ...
                    <Textarea 
                      id="improvements" 
                      placeholder="専門性の向上、指導力の強化、資格取得への意欲など"
                      className="min-h-[80px]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea 
                      id="development-plan" 
                      placeholder="中堅看護補助者に向けた目標、必要な研修、キャリア開発支援など"
                      className="min-h-[100px]"
                    />
                  </div>
                  ...
                  <div className="border-t pt-4">
                    ...
                    <Textarea 
                      id="final-comment" 
                      placeholder="初級看護補助者としての成長状況、慢性期医療での貢献度、将来性など"
