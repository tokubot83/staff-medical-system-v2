      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            【慢性期医療】初級准看護師（2-3年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 准看護師としての自立的な業務遂行と慢性期ケアの実践力を重視
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              <br />
              慢性期医療における初級准看護師は、療養上の世話の自立的実施と後輩指導の開始を重点的に評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  ...
                  <div>
                    ...
                    <Input type="text" id="guidance-role" placeholder="新人准看護師指導担当等" />
                  </div>
                </div>
              </div>
            ...
            <TabsContent value="technical" className="space-y-6 mt-6">
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:高度な実践力 A:確実な実践 B:標準的実践 C:改善余地あり D:要指導
                      <br />
                      （褥瘡予防ケア、認知症ケア、終末期の基礎ケア、リハビリテーション介助等）
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:優れた理解と応用 A:良好な理解 B:基本的理解 C:理解不足 D:大幅な不足
                      <br />
                      （慢性疾患の経過観察、状態変化の気づき、適切な報告等）
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:深い信頼関係構築 A:良好な関係 B:適切な対応 C:改善必要 D:要指導
                      <br />
                      （個別性の理解、家族支援、精神的ケア等）
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:予防的介入の実践 A:確実な管理 B:基本的管理 C:不十分 D:リスクあり
                      <br />
                      （転倒予防、誤嚥予防、感染予防、皮膚トラブル予防等）
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-4">
                  ...
                  <Textarea 
                    id="superior-comment" 
                    placeholder="自立的な業務遂行状況、慢性期ケアの実践力、後輩指導の様子など具体的に記載"
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="mt-4">
                  ...
                  <Textarea 
                    id="self-reflection" 
                    placeholder="自立的な業務での工夫、患者ケアでの成長、後輩指導での学びなど"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
            ...
            <TabsContent value="facility" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  慢性期病棟でのチーム貢献・後輩指導・改善活動を評価
                  <br />
                  初級准看護師としての役割発揮と積極的な組織参加を重視
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="border rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex items-start">
                      ...
                      <span>新人准看護師への指導・サポート</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">2.</span>
                      <span>慢性期ケアの業務改善提案と実践</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">3.</span>
                      <span>チーム内での調整役・リーダーシップ</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">4.</span>
                      <span>委員会活動・勉強会での積極的参加</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">5.</span>
                      <span>病棟運営への協力（シフト調整、業務分担等）</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="後輩指導の実績、業務改善の成果、チーム貢献の具体例など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="border rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex items-start">
                      <span className="font-medium mr-2">3.</span>
                      <span>法人研修での学習成果と知識共有</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">4.</span>
                      <span>他部署・他施設との連携強化</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">5.</span>
                      <span>看護師資格取得への取り組み（該当者）</span>
                    </div>
                  </div>
                </div>
            ...
            <TabsContent value="summary" className="space-y-6 mt-6">
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="strengths">特に優れている点（初級准看護師としての観点から）</Label>
                    <Textarea 
                      id="strengths" 
                      placeholder="自立的な業務遂行、患者ケアの質、後輩指導力など"
                  ...
                  <div>
                    ...
                    <Textarea 
                      id="improvements" 
                      placeholder="専門性の向上、リーダーシップ、看護師資格取得への意欲など"
                      className="min-h-[80px]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea 
                      id="development-plan" 
                      placeholder="中堅准看護師に向けた目標、必要な研修、キャリア開発支援など"
                      className="min-h-[100px]"
                    />
                  </div>
                  ...
                  <div className="border-t pt-4">
                    ...
                    <Textarea 
                      id="final-comment" 
                      placeholder="初級准看護師としての成長状況、慢性期医療での貢献度、将来性など"
