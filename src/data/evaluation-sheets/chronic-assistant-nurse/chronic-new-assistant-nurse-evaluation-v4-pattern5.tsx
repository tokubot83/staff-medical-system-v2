      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 准看護師の業務範囲での基礎習得と慢性期ケアへの適応を重視
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              <br />
              慢性期医療における新人准看護師は、業務範囲内での療養上の世話技術習得と生活支援の実践を重点的に評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="basic" className="space-y-4 mt-6">
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  ...
                  <div>
                    <Label htmlFor="education">准看護師免許取得年</Label>
                    <Input type="text" id="education" placeholder="2024年2月取得" />
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4 mt-4">
                  <div>
                  ...
                  <div>
                    <Label htmlFor="preceptor">指導者</Label>
            ...
            <TabsContent value="technical" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  ...
                  <br />
                  准看護師の業務範囲内での療養上の世話技術と慢性期ケアの基礎習得を重視
                </p>
              </div>
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-4">
                  <div>
                    <Label className="text-sm font-medium">1. 療養上の世話技術の習得</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      ...
                      <br />
                      （清潔ケア、食事介助、排泄ケア、移動介助、体位変換等）
                    </p>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">2. 慢性期ケアの基礎知識と理解</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      ...
                      <br />
                      （長期療養、褥瘡予防、廃用症候群予防、認知症ケアの基礎等）
                    </p>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">3. 患者の日常生活支援と寄り添い</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      ...
                      <br />
                      （傾聴、声かけ、生活リズムの把握、個別性への配慮等）
                    </p>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">4. 安全管理と感染予防の実践</Label>
                ...
                <div className="mt-4">
                  ...
                  <Textarea 
                    id="superior-comment" 
                    placeholder="准看護師としての業務遂行状況、慢性期ケアへの適応、優れた点、改善が必要な点など具体的に記載"
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="mt-4">
                  ...
                  <Textarea 
                    id="self-reflection" 
                    placeholder="療養上の世話での学び、患者との関わりで感じたこと、今後の課題など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="border rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex items-start">
                      ...
                      <span>療養チームでの協働姿勢（報告・連絡・相談の実践）</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">2.</span>
                      <span>日常ケアでの改善提案・工夫（環境整備、ケアの効率化等）</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">3.</span>
                      <span>病棟業務への積極的参加（配膳、リネン交換、清掃等）</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">4.</span>
                      <span>准看護師研修での学習姿勢と実践への活用</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">5.</span>
                      <span>レクリエーション活動・季節行事への参加協力</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <Input 
                    type="number" 
                    id="facility-points" 
                    placeholder="例：75ポイント" 
                    className="mt-2"
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    年間累計ポイントを記入（業務改善、勉強会参加、行事協力等）
                  </p>
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="療養チームでの役割、日常業務での工夫、同僚への協力など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="border rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex items-start">
                      <span className="font-medium mr-2">1.</span>
                      <span>法人理念に基づく療養上の世話の実践</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">2.</span>
                      <span>患者・家族の満足度向上への貢献</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">3.</span>
                      <span>法人准看護師研修での成績・取り組み姿勢</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">4.</span>
                      <span>慢性期ケアの基礎技術向上への努力</span>
                    </div>
                    <div className="flex items-start">
                      <span className="font-medium mr-2">5.</span>
                      <span>他部署・他職種との協力関係構築</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="患者ケアの質向上への取り組み、研修での成果、他施設との交流など"
                    className="min-h-[100px]"
                  />
                </div>
              </div>
            ...
            <TabsContent value="summary" className="space-y-6 mt-6">
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="strengths">特に優れている点（准看護師としての観点から）</Label>
                    <Textarea 
                      id="strengths" 
                      placeholder="療養上の世話での丁寧さ、患者への寄り添い、チーム協調性など"
                  ...
                  <div>
                    ...
                    <Textarea 
                      id="improvements" 
                      placeholder="技術の習熟度向上、慢性期ケアの理解深化、報告・連絡の改善など"
                      className="min-h-[80px]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea 
                      id="development-plan" 
                      placeholder="2年目に向けた具体的な目標、必要な研修・支援、看護師資格取得への意向など"
                      className="min-h-[100px]"
                    />
                  </div>
                  ...
                  <div className="border-t pt-4">
                    ...
                    <Textarea 
                      id="final-comment" 
                      placeholder="准看護師としての適性、慢性期医療での成長可能性、将来のキャリア展望など"
