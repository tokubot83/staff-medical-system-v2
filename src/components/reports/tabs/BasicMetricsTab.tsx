...
export default function BasicMetricsTab({ selectedFacility }: BasicMetricsTabProps) {
  const basicReports = allReports.filter(report => report.type === 'basic');
    ...
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        <p className="text-gray-600 mb-6">
          組織の現状を把握するための基本的な指標レポートです。定期的にチェックして組織の健全性を確認しましょう。
        </p>
      </div>
