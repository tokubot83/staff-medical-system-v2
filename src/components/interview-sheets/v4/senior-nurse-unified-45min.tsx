...
export default function SeniorNurseUnified45MinInterviewSheet() {
  return (
      ...
      <Card>
        <CardHeader className="bg-amber-50">
          ...
          <Alert className="mt-3">
            ...
            <AlertDescription>
              45分の詳細面談です。中堅看護師のリーダーシップ開発、専門性向上、組織貢献を包括的に支援してください。
            </AlertDescription>
          </Alert>
        </CardHeader>
