...
type TechnicalScoreCategory = 'leadership' | 'expertise' | 'education' | 'management';
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老健 中堅看護師（4-10年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            介護老人保健施設における中堅看護師の評価
          </p>
        </CardHeader>
        <CardContent>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="employeeCode" placeholder="例: RN003" />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input id="position" placeholder="中堅看護師" defaultValue="中堅看護師" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <Tabs defaultValue="superior" className="w-full">
                      ...
                      <TabsContent value="superior" className="space-y-4">
                        <div className="space-y-4">
                          <div>
                            <Label className="text-base font-semibold">1. リーダーシップ・チーム運営</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              チームリーダーとしての役割、施設内連携の推進
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">2. 専門性・在宅復帰支援</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              老健特有の専門知識、在宅復帰への高度な支援
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">4. 業務管理・改善活動</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              業務効率化、QOL向上の取り組み、委員会活動
                            </p>
                              ...
                              <div className="flex space-x-4">
                                {['S', 'A', 'B', 'C', 'D'].map(grade => (
                                  <div key={grade} className="flex items-center">
                                    ...
                                    <Label htmlFor={`superior-management-${grade}`} className="ml-2">
                                      {grade}({grade === 'S' ? '優秀' : grade === 'A' ? '良好' : grade === 'B' ? '標準' : grade === 'C' ? '要努力' : '要改善'})
                                    </Label>
                                  </div>
                                ))}
                              ...
                              <div className="flex space-x-4">
                                {['S', 'A', 'B', 'C', 'D'].map(grade => (
                                  <div key={grade} className="flex items-center">
                                    ...
                                    <Label htmlFor={`self-management-${grade}`} className="ml-2">
                                      {grade}({grade === 'S' ? '優秀' : grade === 'A' ? '良好' : grade === 'B' ? '標準' : grade === 'C' ? '要努力' : '要改善'})
                                    </Label>
                                  </div>
                                ))}
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        この評価シートは、老健における中堅看護師の成長と貢献度を公正に評価し、
                        今後のキャリア開発を明確にすることを目的としています。
                      </p>
                    </div>
                    <div>
                      <h3 className="font-semibold mb-2">中堅看護師の期待役割</h3>
                      <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                        <li>チームリーダーとしての役割を果たす</li>
                        <li>在宅復帰支援の中核を担う</li>
                        <li>後輩指導と教育プログラムの企画・実施</li>
                        <li>委員会活動や施設運営への積極的参画</li>
                        <li>多職種連携の中心的役割</li>
                      </ul>
                    </div>
                  </div>
