...
type TechnicalScoreCategory = 'nursingSkills' | 'safety' | 'communication' | 'adaptation';
...
export default function RokenNewNurseEvaluationV4Pattern5() {
  ...
  const [technicalScores, setTechnicalScores] = useState<{
    ...
    superiorEval: { nursingSkills: 0, safety: 0, communication: 0, adaptation: 0 },
    selfEval: { nursingSkills: 0, safety: 0, communication: 0, adaptation: 0 }
  });
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老健 新人看護師（1年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            介護老人保健施設における新人看護師の評価
          </p>
        </CardHeader>
        <CardContent>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="employeeCode" placeholder="例: RN001" />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input id="position" placeholder="新人看護師" defaultValue="新人看護師" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <Tabs defaultValue="superior" className="w-full">
                      ...
                      <TabsContent value="superior" className="space-y-4">
                        <div className="space-y-4">
                          <div>
                            <Label className="text-base font-semibold">1. 看護技術・介護保険制度理解</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              老健における基本的な看護技術、介護保険制度の理解度
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">2. 安全管理・感染対策</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              施設特有のリスク管理、感染症対策の実践
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">3. 多職種連携・コミュニケーション</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              介護職、リハビリ職との連携、利用者・家族との関わり
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">4. 在宅復帰支援・学習姿勢</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              在宅復帰への取り組み、積極的な学習と成長
                            </p>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        この評価シートは、老健における新人看護師の成長と貢献度を公正に評価し、
                    ...
                    <div>
                      <h3 className="font-semibold mb-2">老健看護師の特性</h3>
                      <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                        <li>在宅復帰支援を重視した看護実践</li>
                        <li>介護職・リハビリ職との密な連携</li>
                        <li>利用者の生活機能維持・向上への取り組み</li>
                        <li>認知症ケアの実践</li>
                        <li>家族支援と退所調整</li>
                      </ul>
                    </div>
