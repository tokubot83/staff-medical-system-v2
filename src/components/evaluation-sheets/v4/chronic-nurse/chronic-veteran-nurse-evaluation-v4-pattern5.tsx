...
// Type definitions
type TechnicalScoreCategory = 'influence' | 'succession' | 'innovation' | 'mentorship';
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            【慢性期医療】ベテラン看護師（7年目以上） 人事評価シート v4.0
          </CardTitle>
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  ...
                  <div>
                    ...
                    <Input type="text" id="corp-experience" placeholder="例：12年目" />
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4 mt-4">
                  <div>
            ...
            <TabsContent value="technical" className="space-y-6 mt-6">
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('superiorEval', 'influence', value as keyof typeof gradeToScore)}>
                  ...
                  <div>
                    ...
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('superiorEval', 'succession', value as keyof typeof gradeToScore)}>
                      <div className="grid grid-cols-5 gap-2 mt-2">
                        {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                          <div key={grade} className="flex items-center space-x-1">
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-4">
                  <div>
                    <Label className="text-sm font-medium">1. 慢性期ケア文化への影響力</Label>
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('selfEval', 'influence', value as keyof typeof gradeToScore)}>
                      <div className="grid grid-cols-5 gap-2 mt-2">
                        {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                          <div key={grade} className="flex items-center space-x-1">
                  ...
                  <div>
                    <Label className="text-sm font-medium">2. 慢性期ケア知識・技術の継承</Label>
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('selfEval', 'succession', value as keyof typeof gradeToScore)}>
                      <div className="grid grid-cols-5 gap-2 mt-2">
                        {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                          <div key={grade} className="flex items-center space-x-1">
