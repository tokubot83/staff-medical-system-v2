...
// Type definitions
type TechnicalScoreCategory = 'teamManagement' | 'hrDevelopment' | 'operations' | 'leadership';
            ...
            <TabsContent value="technical" className="space-y-6 mt-6">
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('superiorEval', 'teamManagement', value as keyof typeof gradeToScore)}>
                  ...
                  <div>
                    ...
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('superiorEval', 'hrDevelopment', value as keyof typeof gradeToScore)}>
                      <div className="grid grid-cols-5 gap-2 mt-2">
                        {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                          <div key={grade} className="flex items-center space-x-1">
                  ...
                  <div>
                    ...
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('superiorEval', 'operations', value as keyof typeof gradeToScore)}>
                      <div className="grid grid-cols-5 gap-2 mt-2">
                        {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                          <div key={grade} className="flex items-center space-x-1">
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-4">
                  <div>
                    <Label className="text-sm font-medium">1. 慢性期ケアチームの管理・統括</Label>
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('selfEval', 'teamManagement', value as keyof typeof gradeToScore)}>
                      <div className="grid grid-cols-5 gap-2 mt-2">
                        {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                          <div key={grade} className="flex items-center space-x-1">
                  ...
                  <div>
                    <Label className="text-sm font-medium">2. 慢性期ケア人材育成・能力開発</Label>
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('selfEval', 'hrDevelopment', value as keyof typeof gradeToScore)}>
                      <div className="grid grid-cols-5 gap-2 mt-2">
                        {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                          <div key={grade} className="flex items-center space-x-1">
                  ...
                  <div>
                    <Label className="text-sm font-medium">3. 療養病棟運営への参画</Label>
                    <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('selfEval', 'operations', value as keyof typeof gradeToScore)}>
                      <div className="grid grid-cols-5 gap-2 mt-2">
                        {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                          <div key={grade} className="flex items-center space-x-1">
