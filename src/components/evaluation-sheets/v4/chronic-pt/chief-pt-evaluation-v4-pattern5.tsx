      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            療養型リハビリテーション主任（理学療法士） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 療養型病床のリハビリテーション部門統括と組織マネジメントを重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              療養型病床におけるリハビリテーション主任の組織マネジメントと部門統括力を評価します。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（部門統括、品質管理、標準化推進）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>治療技術（組織最適化、イノベーション推進、成果最大化）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>長期リハビリ計画立案（戦略的組織運営、資源最適化、改革推進）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>記録・報告書作成能力（組織マネジメント、人材開発、成果報告）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、療養型病床リハビリテーション部門の統括、部門成果向上、組織マネジメント、
                      人材育成・開発、組織改革・制度改善、施設運営への参画等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="療養型病床のリハビリテーション主任として特に優れている点、組織マネジメント能力を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる成長のために改善が必要な点、組織マネジメントの高度化に関する課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた具体的な目標、部門運営の高度化・最適化に関する目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="療養型病床リハビリテーション部門の総合的な評価コメント、組織への期待と将来性についてを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
