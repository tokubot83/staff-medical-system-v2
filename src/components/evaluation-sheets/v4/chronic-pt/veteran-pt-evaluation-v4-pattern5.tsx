      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            療養型ベテラン理学療法士（11年以上） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 慢性期リハビリテーションの卓越した専門性と組織牽引力を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              療養型病床におけるベテラン理学療法士の卓越した専門性と組織への貢献を評価します。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（卓越した専門性、困難症例対応、予後予測の精度）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>治療技術（革新的技術、エビデンス創出、QOL最適化）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>長期リハビリ計画立案（戦略的視点、組織横断的連携、専門的指導）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>記録・報告書作成能力（組織運営、人材育成、制度改善提案）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、療養型病床でのリハビリ実施単位数、患者・家族満足度、組織運営への参画、
                      人材育成・教育、専門性向上への貢献、制度改善・新規事業推進等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="療養型病床でのベテラン理学療法士として特に優れている点、組織牽引力・専門性を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる成長のために改善が必要な点、組織運営・制度改善に関する課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた具体的な目標、組織変革・専門性向上に関する目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="療養型病床での総合的な評価コメント、組織への貢献と将来性についてを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
