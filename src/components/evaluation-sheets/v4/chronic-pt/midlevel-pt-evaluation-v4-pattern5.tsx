      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            療養型中堅理学療法士（4-10年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 慢性期リハビリテーションの専門性発揮と指導力・チームリーダーシップを重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              療養型病床における中堅理学療法士の専門性発揮と組織への貢献を評価します。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（専門性発揮、複雑症例対応、長期的変化予測）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>治療技術（高度技術、エビデンス活用、QOL最大化）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>長期リハビリ計画立案（包括的視点、指導力、家族支援計画）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>記録・報告書作成能力（指導・監督、改善提案、標準化推進）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、療養型病床でのリハビリ実施単位数、患者・家族満足度、チーム医療リーダーシップ、
                      後進指導、業務改善・標準化推進、長期療養患者の生活の質向上等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="療養型病床での中堅理学療法士として特に優れている点、専門性・指導力を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる成長のために改善が必要な点、管理職候補としての課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた具体的な目標、組織運営・人材育成に関する目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="療養型病床での総合的な評価コメント、将来への期待を記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
