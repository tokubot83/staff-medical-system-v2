      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            療養型若手理学療法士（2-3年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 慢性期リハビリテーションの実践力と自立的業務遂行を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              療養型病床における若手理学療法士の実践力向上と自立性を評価します。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（包括的評価、機能予後予測、状態変化察知）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>治療技術（個別性重視の治療、QOL向上、意欲向上支援）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>長期リハビリ計画立案能力（多職種連携、家族指導計画）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、療養型病床でのリハビリ実施単位数、患者・家族満足度、多職種との連携、
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="療養型病床での若手理学療法士として特に優れている点、自立的な業務遂行能力を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる成長のために改善が必要な点、慢性期リハビリテーションの専門性向上課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた具体的な目標、中堅職員への成長に向けた目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="療養型病床でのリハビリテーション業務に関する総合的な評価コメント、将来性についてを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
