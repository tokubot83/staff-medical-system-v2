      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            療養型新人理学療法士（1年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 慢性期リハビリテーションの基礎技術習得と患者との長期関わりを重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              療養型病床における新人理学療法士の成長と学習を支援する評価を行います。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（基本的評価、ADL評価、認知機能評価等）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>治療技術（維持期リハ、廃用症候群予防、ADL維持向上）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>長期リハビリ計画立案能力（QOL重視、生活の質向上）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>記録・報告書作成能力（継続的な記録、家族連携）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、療養型病床でのリハビリ実施単位数、患者・家族満足度、チーム医療への参加、
                      長期入院患者への継続的関わり等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="療養型病床での新人理学療法士として特に優れている点、患者との関わり方で評価できる点を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる成長のために改善が必要な点、慢性期リハビリテーションの理解を深める課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた具体的な目標、長期入院患者への関わり方の向上目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="療養型病床でのリハビリテーション業務に関する総合的な評価コメントを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
