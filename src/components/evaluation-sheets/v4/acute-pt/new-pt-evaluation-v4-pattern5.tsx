      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            新人理学療法士（1年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 基礎技術習得と臨床適応を重視した評価
          </p>
        </CardHeader>
        <CardContent>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（ROM、MMT、バランス評価等）</Label>
                        <RadioGroup 
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="新人理学療法士として特に優れている点、成長が見られた点を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた具体的な目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="総合的な評価コメントを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
