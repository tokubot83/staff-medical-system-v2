                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <Label>リハビリ計画立案能力（自立性、創意工夫）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、リハビリテーション実施単位数、患者満足度、チーム医療への貢献、
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="若手理学療法士として特に優れている点、成長が見られた点を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
