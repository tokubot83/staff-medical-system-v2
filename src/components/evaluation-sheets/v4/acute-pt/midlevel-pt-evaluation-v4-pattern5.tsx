      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            中堅理学療法士（4-10年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 専門性深化と指導力・チームリーダーシップを重視した評価
          </p>
        </CardHeader>
        <CardContent>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <Label>リハビリ計画立案能力（包括的視点、指導力）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>記録・報告書作成能力（指導・監督、改善提案）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、リハビリテーション実施単位数、患者満足度、チーム医療リーダーシップ、
                      後進指導、研究・教育活動、業務改善・標準化推進等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="中堅理学療法士として特に優れている点、専門性・指導力を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="総合的な評価コメント、将来への期待を記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
