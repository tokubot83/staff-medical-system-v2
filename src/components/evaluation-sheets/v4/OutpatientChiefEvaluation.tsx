...
import evaluationData from '@/data/evaluation-sheets/v4/outpatient-chief.json';

type TechnicalScoreCategory = 'team-management' | 'staff-development' | 'outpatient-operations' | 'leadership';
type EvaluatorType = 'superiorEval' | 'selfEval';

export default function OutpatientChiefEvaluation() {
          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="basic" className="space-y-4 mt-6">
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  ...
                  <div>
                    <Label htmlFor="experience">主任経験年数</Label>
                    <Input type="text" id="experience" placeholder="3年目" />
                  </div>
                </div>
              </div>
            ...
            <TabsContent value="technical" className="space-y-6 mt-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <Textarea 
                  id="self-reflection" 
                  placeholder="チーム管理での成果、スタッフ育成での工夫、今後の課題など"
            ...
            <TabsContent value="facility" className="space-y-6 mt-6">
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <h4 className="font-semibold mb-3">施設内相対評価（外来主任間）</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div>
            ...
            <TabsContent value="corporate" className="space-y-6 mt-6">
              ...
              <div className="bg-orange-50 p-4 rounded-lg">
                <h4 className="font-semibold mb-3">法人内相対評価（全主任間）</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div>
              ...
              <div>
                ...
                <div className="mt-6 space-y-4">
                  <div>
                    ...
                    <Textarea 
                      id="next-challenges" 
                      placeholder="管理能力の向上、チーム力強化、新たな取り組みなど"
                  ...
                  <div>
                    ...
                    <Textarea 
                      ...
                      placeholder="管理能力、リーダーシップ、組織貢献などを記入"
                      className="min-h-[100px]"
                    />
                  </div>
                </div>
