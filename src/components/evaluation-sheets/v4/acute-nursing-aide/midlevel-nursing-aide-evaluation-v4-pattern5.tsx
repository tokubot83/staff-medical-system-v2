...
// Type definitions
type TechnicalScoreCategory = 'expertise' | 'leadership' | 'innovation' | 'education';
...
export default function MidlevelNursingAideEvaluationV4Pattern5() {
  ...
  const [technicalScores, setTechnicalScores] = useState<{
    ...
    superiorEval: { expertise: 0, leadership: 0, innovation: 0, education: 0 },
    selfEval: { expertise: 0, leadership: 0, innovation: 0, education: 0 }
  });
        ...
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              <br />
              中堅看護補助者は高度な専門性とチームリーダーシップを重点的に評価します
            </AlertDescription>
          </Alert>
              ...
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell>
                      <div>
                        <p className="font-semibold">1. 専門的介護技術</p>
                        <p className="text-sm text-gray-600">
                          高度な介護技術、難易度の高いケースへの対応、専門知識の活用
                        </p>
                      </div>
                    </TableCell>
                    <TableCell>
                  ...
                  <TableRow>
                    <TableCell>
                      <div>
                        <p className="font-semibold">2. リーダーシップ</p>
                        <p className="text-sm text-gray-600">
                          チーム調整、後輩のサポート、業務リーダーとしての役割
                        </p>
                      </div>
                    </TableCell>
                    <TableCell>
                  ...
                  <TableRow>
                    <TableCell>
                      <div>
                        <p className="font-semibold">3. 業務改善・創意工夫</p>
                        <p className="text-sm text-gray-600">
                          業務効率化の提案、新しい取り組みの実施、問題解決能力
                        </p>
                      </div>
                    </TableCell>
                    <TableCell>
                  ...
                  <TableRow>
                    <TableCell>
                      <div>
                        <p className="font-semibold">4. 教育・指導力</p>
                        <p className="text-sm text-gray-600">
                          新人・後輩教育、技術指導、研修講師としての活動
                        </p>
                      </div>
                    </TableCell>
                    <TableCell>
                        ...
                        <div className="flex justify-center space-x-2">
                          {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                            <div key={grade} className="flex items-center">
                              ...
                              <Label htmlFor={`superior-education-${grade}`} className="ml-1 cursor-pointer">
                                {grade}
                              </Label>
                            </div>
                          ))}
                        ...
                        <div className="flex justify-center space-x-2">
                          {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                            <div key={grade} className="flex items-center">
                              ...
                              <Label htmlFor={`self-education-${grade}`} className="ml-1 cursor-pointer">
                                {grade}
                              </Label>
                            </div>
                          ))}
