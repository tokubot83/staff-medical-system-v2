        ...
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              <br />
              新人看護補助者は基礎技術の習得状況と職場への適応・チーム貢献を重点的に評価します
            </AlertDescription>
          </Alert>
              ...
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell>
                      <div>
                        <p className="font-semibold">1. 基礎的介護技術</p>
                        <p className="text-sm text-gray-600">
                          環境整備、清潔援助、食事援助、排泄援助、移送・移乗援助
                        </p>
                      </div>
                    </TableCell>
                    <TableCell>
                  ...
                  <TableRow>
                    <TableCell>
                      <div>
                        <p className="font-semibold">2. 安全管理</p>
                        <p className="text-sm text-gray-600">
                          転倒・転落予防、感染防止対策、医療安全の理解と実践
                        </p>
                      </div>
                    </TableCell>
                    <TableCell>
                  ...
                  <TableRow>
                    <TableCell>
                      <div>
                        <p className="font-semibold">3. コミュニケーション</p>
                        <p className="text-sm text-gray-600">
                          患者・家族対応、報告・連絡・相談、チーム連携
                        </p>
                      </div>
                    </TableCell>
                    <TableCell>
                  ...
                  <TableRow>
                    <TableCell>
                      <div>
                        <p className="font-semibold">4. 職場適応・学習姿勢</p>
                        <p className="text-sm text-gray-600">
                          業務への積極性、研修参加、チーム貢献、自己研鑽
                        </p>
                      </div>
                    </TableCell>
                    <TableCell>
                      <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('superiorEval', 'adaptation', value as keyof typeof gradeToScore)}>
                        <div className="flex justify-center space-x-2">
                          {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                            <div key={grade} className="flex items-center">
                              <RadioGroupItem value={grade} id={`superior-adapt-${grade}`} />
                              <Label htmlFor={`superior-adapt-${grade}`} className="ml-1 cursor-pointer">
                                {grade}
                              </Label>
                            </div>
                          ))}
                    ...
                    <TableCell>
                      <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('selfEval', 'adaptation', value as keyof typeof gradeToScore)}>
                        <div className="flex justify-center space-x-2">
                          {['S', 'A', 'B', 'C', 'D'].map((grade) => (
                            <div key={grade} className="flex items-center">
                              <RadioGroupItem value={grade} id={`self-adapt-${grade}`} />
                              <Label htmlFor={`self-adapt-${grade}`} className="ml-1 cursor-pointer">
                                {grade}
                              </Label>
                            </div>
                          ))}
