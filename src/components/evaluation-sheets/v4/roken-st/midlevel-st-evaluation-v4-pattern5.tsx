...
export default function MidlevelSTEvaluationV4Pattern5() {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老人保健施設中堅言語聴覚士（4-10年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 老健言語聴覚療法の専門性と在宅復帰支援のリーダーシップを重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              老人保健施設における中堅言語聴覚士の高度な専門性と組織への貢献を支援する評価を行います。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（高度な言語機能評価、複合的嚥下機能評価、認知機能評価、コミュニケーション評価、高次脳機能評価）</Label>
                      ...
                      <div>
                        <Label>治療技術（専門的言語療法、高度嚥下訓練、構音訓練、失語症専門訓練、認知症コミュニケーション専門支援、困難症例対応）</Label>
                      ...
                      <div>
                        <Label>在宅復帰支援計画立案能力（個別対応計画、コミュニケーション機能改善、嚥下安全性確保、家族・地域連携）</Label>
                      ...
                      <div>
                        <Label>記録・報告書作成能力（包括的記録、多職種連携調整、データ分析・活用、指導記録作成）</Label>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      ...
                      チーム医療でのリーダーシップ、コミュニケーション機能・嚥下機能改善への主導的取り組み、後輩指導・育成、
                      研修・委員会活動への参加等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="老人保健施設での中堅言語聴覚士として特に優れている点、コミュニケーション支援への専門的取り組みを記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた具体的な目標、在宅復帰率向上とリーダーシップ発揮の目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="老人保健施設での言語聴覚療法業務に関する総合的な評価コメントと今後のリーダーシップ期待を記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
