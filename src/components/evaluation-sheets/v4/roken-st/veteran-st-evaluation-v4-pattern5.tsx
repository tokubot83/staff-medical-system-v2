...
export default function VeteranSTEvaluationV4Pattern5() {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老人保健施設ベテラン言語聴覚士（11年以上） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 老健言語聴覚療法の高度な専門性と組織貢献・指導力を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              老人保健施設におけるベテラン言語聴覚士の高度な専門性と組織への貢献・指導力を支援する評価を行います。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（最高度の言語機能評価、包括的嚥下機能評価、高次認知機能評価、複合コミュニケーション評価、脳機能評価）</Label>
                      ...
                      <div>
                        <Label>治療技術（最高度言語療法、専門的嚥下訓練、構音訓練、失語症専門訓練、認知症コミュニケーション専門支援、困難症例対応）</Label>
                      ...
                      <div>
                        <Label>在宅復帰支援計画立案能力（戦略的復帰計画、包括的コミュニケーション改善、嚥下安全性確保、地域包括ケア連携）</Label>
                      ...
                      <div>
                        <Label>記録・報告書作成能力（専門的記録、多職種連携統括、データ分析・活用・指導、研究・発表）</Label>
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、老人保健施設での言語聴覚療法実施単位数、在宅復帰率向上への専門的貢献、利用者・家族満足度、
                      チーム医療での統括的リーダーシップ、コミュニケーション機能・嚥下機能改善への先導的取り組み、後輩指導・育成の主導、
                      研修・委員会活動のリーダーシップ、研究・学会発表活動、施設運営への参画等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="老人保健施設でのベテラン言語聴覚士として特に優れている点、コミュニケーション支援への専門的取り組みを記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる成長のために改善が必要な点、老健言語聴覚療法の専門性をさらに高める課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた具体的な目標、在宅復帰率向上と組織運営への貢献目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="老人保健施設での言語聴覚療法業務に関する総合的な評価コメントと今後のリーダーシップへの期待を記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
