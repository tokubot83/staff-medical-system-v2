...
export default function ChiefSTEvaluationV4Pattern5() {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老人保健施設リハビリ主任（言語聴覚士） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 老健言語聴覚療法の統括管理とリハビリ部門マネジメントを重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              老人保健施設におけるリハビリ主任として、言語聴覚療法の統括管理と部門運営を支援する評価を行います。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（統括的言語機能評価、包括的嚥下機能評価、高次認知機能評価、システム化コミュニケーション評価、脳機能評価統括）</Label>
                      ...
                      <div>
                        <Label>治療技術（統括的言語療法、専門的嚥下訓練、構音訓練、失語症専門訓練、認知症コミュニケーション専門支援、困難症例指導）</Label>
                      ...
                      <div>
                        <Label>在宅復帰支援統括能力（戦略的復帰計画統括、包括的コミュニケーション改善指導、嚥下安全性確保統括、地域包括ケア連携統括）</Label>
                      ...
                      <div>
                        <Label>記録・報告書統括能力（部門統括記録、多職種連携統括、データ分析・活用・指導統括、研究・発表指導）</Label>
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、老人保健施設でのリハビリ部門統括管理、言語聴覚療法実施単位数管理、在宅復帰率向上への戦略的貢献、
                      利用者・家族満足度向上、多職種チーム医療の統括リーダーシップ、コミュニケーション機能・嚥下機能改善プログラムの統括、
                      スタッフ指導・育成・人材開発の統括、研修・委員会活動の主導、研究・学会発表活動の推進、
                      施設運営・経営への積極参画、地域連携の構築・推進等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="老人保健施設でのリハビリ主任として特に優れている点、言語聴覚療法部門統括への取り組みを記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる成長のために改善が必要な点、老健リハビリ部門の統括管理能力向上の課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた具体的な目標、在宅復帰率向上と部門運営の統括目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="老人保健施設でのリハビリ主任業務に関する総合的な評価コメントと今後の統括管理への期待を記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
