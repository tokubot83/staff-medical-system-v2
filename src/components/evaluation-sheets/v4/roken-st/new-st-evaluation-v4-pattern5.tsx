...
export default function NewSTEvaluationV4Pattern5() {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老人保健施設新人言語聴覚士（1年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 老健言語聴覚療法の基礎技術習得と在宅復帰支援の実践を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              老人保健施設における新人言語聴覚士の成長と学習を支援する評価を行います。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（言語機能評価、嚥下機能評価、認知機能評価、コミュニケーション評価等）</Label>
                      ...
                      <div>
                        <Label>治療技術（言語療法、嚥下訓練、構音訓練、失語症訓練、認知症コミュニケーション支援）</Label>
                      ...
                      <div>
                        <Label>在宅復帰支援計画立案能力（コミュニケーション機能改善、嚥下安全性確保、家族指導）</Label>
                      ...
                      <div>
                        <Label>記録・報告書作成能力（継続的な記録、多職種連携、家族・ケアマネ連携）</Label>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      ...
                      チーム医療への参加、コミュニケーション機能・嚥下機能改善への取り組み等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="老人保健施設での新人言語聴覚士として特に優れている点、コミュニケーション支援への取り組みを記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる成長のために改善が必要な点、老健言語聴覚療法の理解を深める課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた具体的な目標、在宅復帰率向上への貢献目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="老人保健施設での言語聴覚療法業務に関する総合的な評価コメントを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
