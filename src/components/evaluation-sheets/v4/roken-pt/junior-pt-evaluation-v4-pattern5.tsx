...
export default function JuniorPTEvaluationV4Pattern5() {
  // 評価項目の状態管理
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老人保健施設若手理学療法士（2-3年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 老健リハビリテーションの応用技術習得と在宅復帰支援の発展を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              老人保健施設における若手理学療法士の技術向上と自立性の発展を評価します。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>応用評価技術（詳細機能評価、包括的ADL評価、複合的認知評価、環境評価等）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>専門治療技術（個別訓練プログラム、在宅復帰訓練、家族指導実践、介護予防活動）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>中期計画立案能力（在宅復帰支援計画、個別目標設定、多職種連携企画）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>専門記録・指導能力（詳細記録作成、新人サポート、家族・ケアマネ連携）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、老人保健施設での理学療法実施単位数、在宅復帰率向上への貢献、
                      利用者・家族満足度、チーム医療への積極参加、新人指導サポート、研修・勉強会参画等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="老人保健施設での若手理学療法士として特に優れている点、技術向上が認められる点を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる専門性向上のための改善点、自立性発展のための課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた技術向上目標、在宅復帰支援への貢献目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="老人保健施設での若手理学療法士としての総合的な評価コメントを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
