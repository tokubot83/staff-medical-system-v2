...
export default function ChiefPTEvaluationV4Pattern5() {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老人保健施設リハビリ主任（理学療法士） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 老健リハビリテーション部門の統括管理と組織運営・戦略立案を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              老人保健施設におけるリハビリテーション部門の統括者として管理能力と専門性を評価します。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>統括的評価技術（部門全体の評価統制、複合症例統括判定、リスク管理評価）</Label>
                      ...
                      <div>
                        <Label>部門統括技術（スタッフ指導、技術標準化、品質管理、安全管理体制）</Label>
                      ...
                      <div>
                        <Label>組織戦略策定能力（部門運営計画、人材育成戦略、在宅復帰率向上企画、地域連携構築）</Label>
                      ...
                      <div>
                        <Label>管理・統括能力（組織管理、人事管理、教育システム構築、学術・研究活動統括）</Label>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      {/* Similar structure for self evaluation */}
                      <div>
                        <Label>統括的評価技術（部門全体の評価統制、複合症例統括判定、リスク管理評価）</Label>
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、老人保健施設における理学療法部門の統括管理、組織運営への貢献、
                      人材育成・教育システム構築、在宅復帰率向上への取り組み、地域・法人全体への貢献等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="老人保健施設でのリハビリテーション部門統括者として特に優れている点、組織運営能力を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる組織運営能力向上と部門統括力発展のための課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた部門統括目標、組織戦略・人材育成目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="老人保健施設でのリハビリテーション部門統括者としての総合的な評価コメントを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
