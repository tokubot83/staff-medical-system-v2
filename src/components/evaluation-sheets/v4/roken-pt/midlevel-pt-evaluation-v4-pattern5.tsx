...
export default function MidlevelPTEvaluationV4Pattern5() {
  // 評価項目の状態管理
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老人保健施設中堅理学療法士（4-10年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 老健リハビリテーションの高度技術習得と後進指導能力の発展を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              老人保健施設における中堅理学療法士の技術向上とリーダーシップの発展を評価します。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>高度評価技術（包括的機能評価、複合的ADL評価、詳細環境評価、リスク評価等）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>専門的治療技術（重度対応訓練、複合的在宅復帰訓練、家族・介護者指導、地域連携）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>長期戦略的計画立案能力（個別化プログラム、在宅復帰戦略、多職種連携企画）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>指導・教育能力（後進指導、研修企画、家族・ケアマネ教育、地域啓発活動）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、老人保健施設での理学療法の質向上、在宅復帰率向上への貢献、
                      利用者・家族満足度向上、チーム医療におけるリーダーシップ、後進指導・教育活動等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="老人保健施設での中堅理学療法士として特に優れている点、リーダーシップ能力を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる専門性向上のための改善点、指導力発展のための課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた高度技術習得目標、チーム運営・後進指導目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="老人保健施設での理学療法における中堅職員としての総合的な評価コメントを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
