...
export default function NewPTEvaluationV4Pattern5() {
  // 評価項目の状態管理
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老人保健施設新人理学療法士（1年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 老健リハビリテーションの基礎技術習得と在宅復帰支援の実践を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              老人保健施設における新人理学療法士の成長と学習を支援する評価を行います。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（機能評価、ADL評価、認知機能評価、在宅環境評価等）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>治療技術（維持期リハ、在宅復帰訓練、生活機能向上訓練、介護予防）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>在宅復帰支援計画立案能力（家族指導、環境整備、社会資源活用）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、老人保健施設での理学療法実施単位数、在宅復帰率向上への貢献、利用者・家族満足度、
                      チーム医療への参加、介護予防活動への取り組み等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="老人保健施設での新人理学療法士として特に優れている点、在宅復帰支援への取り組みを記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる成長のために改善が必要な点、老健リハビリテーションの理解を深める課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="老人保健施設での理学療法業務に関する総合的な評価コメントを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
