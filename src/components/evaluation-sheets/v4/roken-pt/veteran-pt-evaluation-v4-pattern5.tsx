...
export default function VeteranPTEvaluationV4Pattern5() {
  // 評価項目の状態管理
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老人保健施設ベテラン理学療法士（11年以上） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 老健リハビリテーションの専門性と組織運営・人材育成のリーダーシップを重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              老人保健施設における理学療法のエキスパートとしての専門性と組織貢献を評価します。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>エキスパート評価技術（総合機能評価、複雑症例評価、リスク管理、予後予測等）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>最高度治療技術（困難症例対応、革新的アプローチ、多職種統合療法、地域連携構築）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>組織戦略立案能力（部門運営企画、在宅復帰戦略、人材育成計画、地域ネットワーク構築）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>教育・研究能力（専門教育、学術研究、学会活動、エビデンス構築、後進育成システム）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、老人保健施設での理学療法部門の統括、在宅復帰率向上・地域への貢献、
                      組織運営への参画、専門職としての学術活動、後進育成・教育システム構築等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="老人保健施設での理学療法エキスパートとして特に優れている点、組織貢献を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる専門性の発展と組織運営能力向上のための課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた高度専門技術目標、組織運営・人材育成目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="老人保健施設での理学療法エキスパートとしての総合的な評価コメントを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
