                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <Label>自立支援計画立案（包括的視点、指導力）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、作業療法実施単位数、患者満足度、チーム医療リーダーシップ、
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="中堅作業療法士として特に優れている点、専門性・指導力を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
