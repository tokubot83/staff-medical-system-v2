                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（ADL評価、認知機能評価等）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>治療技術（作業療法、日常生活動作訓練等）</Label>
                        <RadioGroup 
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="新人作業療法士として特に優れている点、成長が見られた点を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
