...
export default function ChiefOTEvaluationV4Pattern5() {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老人保健施設リハビリ主任（作業療法士） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 老健作業療法の統括管理とリハビリ部門マネジメントを重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              老人保健施設におけるリハビリ主任として、作業療法の統括管理と部門運営を支援する評価を行います。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（統括的作業機能評価、包括的ADL評価、高次認知機能評価、システム化環境評価、復帰戦略統括）</Label>
                      ...
                      <div>
                        <Label>治療技術（統括的維持期作業療法、専門的在宅復帰訓練、高度生活機能改善、認知症専門ケア、困難症例指導）</Label>
                      ...
                      <div>
                        <Label>在宅復帰支援統括能力（戦略的復帰計画統括、包括的環境整備指導、福祉用具選定指導、地域包括ケア連携統括）</Label>
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、老人保健施設でのリハビリ部門統括管理、作業療法実施単位数管理、在宅復帰率向上への戦略的貢献、
                      利用者・家族満足度向上、多職種チーム医療の統括リーダーシップ、認知症ケア・生活機能向上プログラムの統括、
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="老人保健施設でのリハビリ主任として特に優れている点、作業療法部門統括への取り組みを記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
