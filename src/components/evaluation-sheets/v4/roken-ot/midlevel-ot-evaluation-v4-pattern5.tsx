...
export default function MidlevelOTEvaluationV4Pattern5() {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老人保健施設中堅作業療法士（4-10年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 老健作業療法の専門性と在宅復帰支援のリーダーシップを重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              老人保健施設における中堅作業療法士の高度な専門性と組織への貢献を支援する評価を行います。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（高度な作業機能評価、複合的ADL評価、認知機能評価、環境評価、復帰可能性判定）</Label>
                      ...
                      <div>
                        <Label>治療技術（専門的維持期作業療法、高度な在宅復帰訓練、生活機能改善、認知症専門ケア、重症度対応）</Label>
                      ...
                      <div>
                        <Label>在宅復帰支援計画立案能力（個別対応計画、包括的環境調整、福祉用具専門選定、家族・地域連携）</Label>
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、老人保健施設での作業療法実施単位数、在宅復帰率向上への専門的貢献、利用者・家族満足度、
                      チーム医療でのリーダーシップ、認知症ケア・生活機能向上への主導的取り組み、後輩指導・育成、
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="老人保健施設での中堅作業療法士として特に優れている点、在宅復帰支援への専門的取り組みを記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる成長のために改善が必要な点、老健作業療法の専門性をさらに高める課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="老人保健施設での作業療法業務に関する総合的な評価コメントと今後のリーダーシップ期待を記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
