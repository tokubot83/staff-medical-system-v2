      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老人保健施設若手作業療法士（2-3年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 老健作業療法の実践力と在宅復帰支援の質的向上を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              老人保健施設における若手作業療法士の専門性向上と実践力強化を支援する評価を行います。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（作業機能評価、ADL評価、認知機能評価、環境評価、復帰阻害因子分析）</Label>
                      ...
                      <div>
                        <Label>治療技術（維持期作業療法、在宅復帰訓練、生活機能向上訓練、認知症ケア、個別対応訓練）</Label>
                      ...
                      <div>
                        <Label>在宅復帰支援計画立案能力（生活指導、環境調整、福祉用具選定、家族指導、ケアマネ連携）</Label>
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、老人保健施設での作業療法実施単位数、在宅復帰率向上への貢献、利用者・家族満足度、
                      チーム医療への参加度、認知症ケア・生活機能向上への取り組み、後輩指導への参加等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="老人保健施設での若手作業療法士として特に優れている点、在宅復帰支援への取り組みを記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる成長のために改善が必要な点、老健作業療法の専門性を高める課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="老人保健施設での作業療法業務に関する総合的な評価コメントと今後の期待を記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
