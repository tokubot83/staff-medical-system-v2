      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老人保健施設ベテラン作業療法士（11年以上） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 老健作業療法の高度な専門性と組織貢献・指導力を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              老人保健施設におけるベテラン作業療法士の高度な専門性と組織への貢献・指導力を支援する評価を行います。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（最高度の作業機能評価、包括的ADL評価、高次認知機能評価、複合環境評価、復帰戦略立案）</Label>
                      ...
                      <div>
                        <Label>治療技術（最高度維持期作業療法、専門的在宅復帰訓練、高度生活機能改善、認知症専門ケア、困難症例対応）</Label>
                      ...
                      <div>
                        <Label>在宅復帰支援計画立案能力（戦略的復帰計画、包括的環境整備、専門的福祉用具選定、地域包括ケア連携）</Label>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      ...
                      チーム医療での統括的リーダーシップ、認知症ケア・生活機能向上への先導的取り組み、後輩指導・育成の主導、
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="老人保健施設でのベテラン作業療法士として特に優れている点、在宅復帰支援への専門的取り組みを記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="老人保健施設での作業療法業務に関する総合的な評価コメントと今後のリーダーシップへの期待を記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
