...
export default function NewOTEvaluationV4Pattern5() {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老人保健施設新人作業療法士（1年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 老健作業療法の基礎技術習得と在宅復帰支援の実践を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              老人保健施設における新人作業療法士の成長と学習を支援する評価を行います。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（作業機能評価、ADL評価、認知機能評価、環境評価等）</Label>
                      ...
                      <div>
                        <Label>治療技術（維持期作業療法、在宅復帰訓練、生活機能向上訓練、認知症ケア）</Label>
                      ...
                      <div>
                        <Label>在宅復帰支援計画立案能力（生活指導、環境調整、福祉用具選定）</Label>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      ...
                      チーム医療への参加、認知症ケア・生活機能向上への取り組み等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="老人保健施設での新人作業療法士として特に優れている点、在宅復帰支援への取り組みを記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる成長のために改善が必要な点、老健作業療法の理解を深める課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  <div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="老人保健施設での作業療法業務に関する総合的な評価コメントを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
