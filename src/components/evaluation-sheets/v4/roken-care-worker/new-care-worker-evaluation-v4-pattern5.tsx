...
type TechnicalScoreCategory = 'careSkills' | 'safety' | 'communication' | 'adaptation';
type EvaluatorType = 'superiorEval' | 'selfEval';

export default function RokenNewCareWorkerEvaluationV4Pattern5() {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老健 新人介護職員（1年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            介護老人保健施設における新人介護職員（無資格）の評価
          </p>
        </CardHeader>
        <CardContent>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="employeeCode" placeholder="例: CA001" />
                    </div>
                    <div>
                      <Label htmlFor="employeeName">氏名</Label>
                      <Input id="employeeName" placeholder="山田 太郎" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      <Input id="position" placeholder="新人介護職員" defaultValue="新人介護職員" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="training">必須研修受講状況</Label>
                      <Input id="training" placeholder="認知症介護基礎研修（予定）" />
                    </div>
                    <div>
                      <Label htmlFor="experience">介護経験</Label>
                      <Input id="experience" placeholder="未経験" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <Tabs defaultValue="superior" className="w-full">
                      ...
                      <TabsContent value="superior" className="space-y-4">
                        <div className="space-y-4">
                          ...
                          <div>
                            <Label className="text-base font-semibold">2. 安全への配慮・感染予防</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              転倒予防、誤嚥防止、感染予防対策の実践、ヒヤリハット報告
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">3. コミュニケーション・報告</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              利用者との関わり、家族対応、職員間連携、報告・連絡・相談
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">4. 学習意欲・職場適応</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              指導の受け入れ、学習への取り組み、規則の遵守、協調性
                            </p>
                            <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('superiorEval', 'adaptation', value as keyof typeof gradeToScore)}>
                              <div className="flex space-x-4">
                                <div className="flex items-center">
                                  <RadioGroupItem value="S" id="superior-adapt-s" />
                                  <Label htmlFor="superior-adapt-s" className="ml-2">S(優秀)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="A" id="superior-adapt-a" />
                                  <Label htmlFor="superior-adapt-a" className="ml-2">A(良好)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="B" id="superior-adapt-b" />
                                  <Label htmlFor="superior-adapt-b" className="ml-2">B(標準)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="C" id="superior-adapt-c" />
                                  <Label htmlFor="superior-adapt-c" className="ml-2">C(要努力)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="D" id="superior-adapt-d" />
                                  <Label htmlFor="superior-adapt-d" className="ml-2">D(要改善)</Label>
                                </div>
                              </div>
                            </RadioGroup>
                          </div>
                      ...
                      <TabsContent value="self" className="space-y-4">
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('selfEval', 'adaptation', value as keyof typeof gradeToScore)}>
                              <div className="flex space-x-4">
                                <div className="flex items-center">
                                  <RadioGroupItem value="S" id="self-adapt-s" />
                                  <Label htmlFor="self-adapt-s" className="ml-2">S(優秀)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="A" id="self-adapt-a" />
                                  <Label htmlFor="self-adapt-a" className="ml-2">A(良好)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="B" id="self-adapt-b" />
                                  <Label htmlFor="self-adapt-b" className="ml-2">B(標準)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="C" id="self-adapt-c" />
                                  <Label htmlFor="self-adapt-c" className="ml-2">C(要努力)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="D" id="self-adapt-d" />
                                  <Label htmlFor="self-adapt-d" className="ml-2">D(要改善)</Label>
                                </div>
                              </div>
                            </RadioGroup>
                          </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <Textarea
                          id="nextGoals"
                          placeholder="次期の具体的な目標を記入してください（資格取得目標含む）"
                          rows={4}
                        />
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        この評価シートは、老健における新人介護職員の成長と貢献度を公正に評価し、
                        今後の育成方針と資格取得への動機付けを明確にすることを目的としています。
                      </p>
                    </div>
                    <div>
                      <h3 className="font-semibold mb-2">技術評価の基準</h3>
                      <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                        <li><strong>S（優秀）</strong>：期待を大きく上回る。他の新人の模範となるレベル</li>
                        <li><strong>A（良好）</strong>：期待を上回る。基本業務を自立して遂行可能</li>
                        <li><strong>B（標準）</strong>：期待通り。指導のもと業務遂行可能</li>
                        <li><strong>C（要努力）</strong>：期待をやや下回る。継続的な支援が必要</li>
                        <li><strong>D（要改善）</strong>：期待を大きく下回る。重点的な指導が必要</li>
                      </ul>
                    </div>
                    <div>
                      <h3 className="font-semibold mb-2">介護職員（無資格）の特性と期待</h3>
                      <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                        <li>基本的な介護技術の習得とOJTでの成長</li>
                        <li>認知症介護基礎研修の受講（2024年度義務化）</li>
                        <li>介護福祉士等の有資格者からの指導を受けた実践</li>
                        <li>チームの一員としての基本的な役割遂行</li>
                        <li>将来的な資格取得への意欲と準備</li>
                      </ul>
                    </div>
                    <div>
                      <h3 className="font-semibold mb-2">キャリアアップへの期待</h3>
                      <p className="text-sm text-gray-600">
                        無資格の介護職員には、実務経験を積みながら介護福祉士資格の取得を目指すことを推奨します。
                        3年以上の実務経験と実務者研修の修了により、介護福祉士国家試験の受験資格が得られます。
                      </p>
                    </div>
                  </div>
                </CardContent>
