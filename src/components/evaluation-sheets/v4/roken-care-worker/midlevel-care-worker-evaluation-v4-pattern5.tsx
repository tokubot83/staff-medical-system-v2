...
type TechnicalScoreCategory = 'careSkills' | 'leadership' | 'communication' | 'development';
type EvaluatorType = 'superiorEval' | 'selfEval';

export default function RokenMidlevelCareWorkerEvaluationV4Pattern5() {
  const [technicalScores, setTechnicalScores] = useState<{
    [key in EvaluatorType]: {
      [key in TechnicalScoreCategory]: number;
    };
  }>({
    superiorEval: { careSkills: 0, leadership: 0, communication: 0, development: 0 },
    selfEval: { careSkills: 0, leadership: 0, communication: 0, development: 0 }
  });
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老健 中堅介護職員（4-10年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            介護老人保健施設における中堅介護職員（無資格）の評価
          </p>
        </CardHeader>
        <CardContent>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="employeeCode" placeholder="例: CS003" />
                    </div>
                    <div>
                      <Label htmlFor="employeeName">氏名</Label>
                      <Input id="employeeName" placeholder="田中 健太" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      <Input id="position" placeholder="中堅介護職員" defaultValue="中堅介護職員" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      <Input id="experience" placeholder="6年3ヶ月" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <Tabs defaultValue="superior" className="w-full">
                      ...
                      <TabsContent value="superior" className="space-y-4">
                        <div className="space-y-4">
                          <div>
                            <Label className="text-base font-semibold">1. 熟練した介護技術</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              複雑な介護技術、効率的な業務遂行、利用者個別性への対応
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">3. 高度なコミュニケーション</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              困難事例対応、家族対応、多職種連携、情報共有の質
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">4. 継続的成長・資格取得</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              介護福祉士取得への具体的取り組み、専門知識習得、技術向上
                            </p>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        この評価シートは、老健における中堅介護職員の成長と貢献度を公正に評価し、
                        今後のキャリア開発を明確にすることを目的としています。
                      </p>
                    </div>
                    <div>
                      <h3 className="font-semibold mb-2">中堅介護職員の期待役割</h3>
                      <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                        <li>熟練した介護技術によるケア提供</li>
                        <li>チーム内でのリーダーシップ発揮</li>
                        <li>後輩職員への指導・サポート</li>
                        <li>困難事例への対応力</li>
                        <li>介護福祉士資格取得に向けた継続的努力</li>
                      </ul>
                    </div>
                  </div>
                </CardContent>
