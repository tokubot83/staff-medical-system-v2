      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            療養型ベテラン言語聴覚士（11年以上） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 療養型言語聴覚療法の専門性と組織運営・人材育成のリーダーシップを重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              療養型病床における言語聴覚療法のエキスパートとしての専門性と組織貢献を評価します。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>エキスパート評価技術（最重度障害評価、複合機能評価、療法適応判定、予後予測）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>最高度治療技術（難治性症例対応、革新的アプローチ、多職種統合療法、家族・地域連携）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>組織戦略立案能力（部門運営企画、療法の質向上戦略、人材育成計画、地域連携構築）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、療養型病床での言語聴覚療法部門の統括、患者・家族・地域への貢献、
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="療養型病床での言語聴覚療法エキスパートとして特に優れている点、組織貢献を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="療養型言語聴覚療法のエキスパートとしての総合的な評価コメントを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
