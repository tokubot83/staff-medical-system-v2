      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            療養型若手言語聴覚士（2-3年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 療養型言語聴覚療法の応用技術習得と自立性発展を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              療養型病床における若手言語聴覚士の技術向上と自立性の発展を評価します。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>応用評価技術（包括的構音評価、詳細嚥下評価、認知機能複合評価等）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>専門治療技術（個別性重視訓練、複合障害対応、家族指導実践）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>中期計画立案能力（個別目標設定、多職種連携企画、QOL向上戦略）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>専門記録・指導能力（詳細記録作成、新人サポート、研修参画）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、療養型病床での言語聴覚療法の質向上、患者満足度、チーム医療への積極参加、
                      新人指導サポート、研修・勉強会参画等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="療養型病床での若手言語聴覚士として特に優れている点、技術向上が認められる点を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた技術向上目標、専門性発展目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="療養型病床での若手言語聴覚士としての総合的な評価コメントを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
