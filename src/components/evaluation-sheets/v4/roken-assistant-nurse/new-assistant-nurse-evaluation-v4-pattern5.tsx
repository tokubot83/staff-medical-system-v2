...
type TechnicalScoreCategory = 'clinicalSkills' | 'safety' | 'communication' | 'learning';
...
export default function RokenNewAssistantNurseEvaluationV4Pattern5() {
  const [technicalScores, setTechnicalScores] = useState<{
    ...
    superiorEval: { clinicalSkills: 0, safety: 0, communication: 0, learning: 0 },
    selfEval: { clinicalSkills: 0, safety: 0, communication: 0, learning: 0 }
  });
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老健 新人准看護師（1年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            介護老人保健施設における新人准看護師の評価
          </p>
        </CardHeader>
        <CardContent>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="employeeCode" placeholder="例: LN001" />
                    </div>
                    <div>
                      <Label htmlFor="employeeName">氏名</Label>
                      <Input id="employeeName" placeholder="田中 さくら" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      <Input id="position" placeholder="新人准看護師" defaultValue="新人准看護師" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      <Input id="licenseNumber" placeholder="第L-12345号" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <Tabs defaultValue="superior" className="w-full">
                      ...
                      <TabsContent value="superior" className="space-y-4">
                        <div className="space-y-4">
                          <div>
                            <Label className="text-base font-semibold">1. 基本的看護技術</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              バイタル測定、与薬確認、清拭・入浴介助、感染対策の基本
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">2. 安全・危険予知</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              転倒予防対策、誤薬防止、リスクの報告・連絡・相談
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">3. コミュニケーション・協働</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              利用者・家族対応、看護師との連携、記録の正確性
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">4. 学習意欲・適応</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              研修参加、知識習得への意欲、老健業務への適応
                            </p>
                            <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('superiorEval', 'learning', value as keyof typeof gradeToScore)}>
                              <div className="flex space-x-4">
                                <div className="flex items-center">
                                  <RadioGroupItem value="S" id="superior-learning-s" />
                                  <Label htmlFor="superior-learning-s" className="ml-2">S(優秀)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="A" id="superior-learning-a" />
                                  <Label htmlFor="superior-learning-a" className="ml-2">A(良好)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="B" id="superior-learning-b" />
                                  <Label htmlFor="superior-learning-b" className="ml-2">B(標準)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="C" id="superior-learning-c" />
                                  <Label htmlFor="superior-learning-c" className="ml-2">C(要努力)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="D" id="superior-learning-d" />
                                  <Label htmlFor="superior-learning-d" className="ml-2">D(要改善)</Label>
                                </div>
                              </div>
                            </RadioGroup>
                          </div>
                      ...
                      <TabsContent value="self" className="space-y-4">
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <RadioGroup onValueChange={(value) => handleTechnicalScoreChange('selfEval', 'learning', value as keyof typeof gradeToScore)}>
                              <div className="flex space-x-4">
                                <div className="flex items-center">
                                  <RadioGroupItem value="S" id="self-learning-s" />
                                  <Label htmlFor="self-learning-s" className="ml-2">S(優秀)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="A" id="self-learning-a" />
                                  <Label htmlFor="self-learning-a" className="ml-2">A(良好)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="B" id="self-learning-b" />
                                  <Label htmlFor="self-learning-b" className="ml-2">B(標準)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="C" id="self-learning-c" />
                                  <Label htmlFor="self-learning-c" className="ml-2">C(要努力)</Label>
                                </div>
                                <div className="flex items-center">
                                  <RadioGroupItem value="D" id="self-learning-d" />
                                  <Label htmlFor="self-learning-d" className="ml-2">D(要改善)</Label>
                                </div>
                              </div>
                            </RadioGroup>
                          </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        この評価シートは、老健における新人准看護師の成長と貢献度を公正に評価し、
                        今後のキャリア開発を明確にすることを目的としています。
                      </p>
                    </div>
                    <div>
                      <h3 className="font-semibold mb-2">新人准看護師の期待役割</h3>
                      <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                        <li>基本的な看護技術の確実な習得</li>
                        <li>安全意識を持った業務遂行</li>
                        <li>利用者・家族への丁寧な対応</li>
                        <li>チーム医療における協働</li>
                        <li>老健の特性を理解した看護の実践</li>
                      </ul>
                    </div>
                  </div>
                </CardContent>
