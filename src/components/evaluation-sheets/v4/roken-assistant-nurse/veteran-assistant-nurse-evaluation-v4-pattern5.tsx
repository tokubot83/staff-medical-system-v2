...
type TechnicalScoreCategory = 'expertise' | 'leadership' | 'education' | 'innovation';
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            老健 ベテラン准看護師（11年以上） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            介護老人保健施設におけるベテラン准看護師の評価
          </p>
        </CardHeader>
        <CardContent>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="employeeCode" placeholder="例: LN004" />
                    </div>
                    <div>
                      <Label htmlFor="employeeName">氏名</Label>
                      <Input id="employeeName" placeholder="山田 美智子" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      <Input id="position" placeholder="ベテラン准看護師" defaultValue="ベテラン准看護師" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      <Input id="licenseNumber" placeholder="第L-45678号" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <Tabs defaultValue="superior" className="w-full">
                      ...
                      <TabsContent value="superior" className="space-y-4">
                        <div className="space-y-4">
                          <div>
                            <Label className="text-base font-semibold">1. 専門性・マスタリー</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              高度な専門知識、熟練した技術、総合的な看護判断力
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">3. 教育・人材育成</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              新人・後輩の系統的指導、研修企画・実施、技術伝承
                            </p>
                          ...
                          <div>
                            <Label className="text-base font-semibold">4. 変革・イノベーション</Label>
                            <p className="text-sm text-gray-600 mb-2">
                              制度改善提案、新制度導入、看護の質向上活動、先駆的取り組み
                            </p>
                              ...
                              <div className="flex space-x-4">
                                {['S', 'A', 'B', 'C', 'D'].map(grade => (
                                  <div key={grade} className="flex items-center">
                                    ...
                                    <Label htmlFor={`superior-innovation-${grade}`} className="ml-2">
                                      {grade}({grade === 'S' ? '優秀' : grade === 'A' ? '良好' : grade === 'B' ? '標準' : grade === 'C' ? '要努力' : '要改善'})
                                    </Label>
                                  </div>
                                ))}
                              ...
                              <div className="flex space-x-4">
                                {['S', 'A', 'B', 'C', 'D'].map(grade => (
                                  <div key={grade} className="flex items-center">
                                    ...
                                    <Label htmlFor={`self-innovation-${grade}`} className="ml-2">
                                      {grade}({grade === 'S' ? '優秀' : grade === 'A' ? '良好' : grade === 'B' ? '標準' : grade === 'C' ? '要努力' : '要改善'})
                                    </Label>
                                  </div>
                                ))}
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        この評価シートは、老健におけるベテラン准看護師の成長と貢献度を公正に評価し、
                        今後のキャリア開発を明確にすることを目的としています。
                      </p>
                    </div>
                    <div>
                      <h3 className="font-semibold mb-2">ベテラン准看護師の期待役割</h3>
                      <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                        <li>専門知識と技術の集大成を発揮する</li>
                        <li>准看護師チーム全体の統括・リーダーシップ</li>
                        <li>系統的な人材育成と技術伝承</li>
                        <li>看護の質向上と変革の推進</li>
                        <li>組織運営への積極的な参画</li>
                      </ul>
