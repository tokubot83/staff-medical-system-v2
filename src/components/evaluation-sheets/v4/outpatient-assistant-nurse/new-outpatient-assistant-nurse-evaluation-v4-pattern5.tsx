...
export default function NewOutpatientAssistantNurseEvaluationV4Pattern5() {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            外来新人准看護師（1年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 准看護師業務範囲での外来看護実践を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              <br />
              外来新人准看護師は指示範囲内での確実な業務遂行、基本的な処置技術、患者対応を重点的に評価します
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="basic" className="space-y-4 mt-6">
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="evaluator1">1次評価者（指導看護師）</Label>
            ...
            <TabsContent value="technical" className="space-y-6 mt-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  ...
                  <br />
                  外来新人准看護師は指示範囲内での確実な業務遂行と基本技術習得を重視
                </p>
              </div>

              <div className="border rounded-lg p-4">
                <h4 className="font-semibold mb-4 text-blue-600">指導看護師・上司評価（60％）</h4>
                
                <div className="space-y-4">
                  <div>
                    <Label className="text-sm font-medium">1. 基本的な処置技術（採血・注射・点滴管理）</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:確実で正確 A:安定した技術 B:標準的 C:不安定 D:要指導
                    </p>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">2. 指示の理解と実行（医師指示・看護師指示の遵守）</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:完璧な理解 A:的確な実行 B:基本的理解 C:理解不足 D:大幅な不足
                    </p>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">3. 患者対応・接遇（基本的なコミュニケーション）</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:優れた対応 A:丁寧な対応 B:標準的 C:改善必要 D:要指導
                    </p>
                  </div>

                  <div>
                    <Label className="text-sm font-medium">4. 安全管理・報告（インシデント予防・適切な報告）</Label>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      S:完璧な管理 A:確実な報告 B:基本的実践 C:不十分 D:リスクあり
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <Textarea 
                  id="self-reflection" 
                  placeholder="業務で努力した点、指示理解での課題、今後の技術向上目標など"
            ...
            <TabsContent value="facility" className="space-y-6 mt-6">
              ...
              <div className="border rounded-lg overflow-hidden">
                <Table>
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      <TableCell>外来業務勉強会参加</TableCell>
                      <TableCell className="text-center">3pt/回</TableCell>
                      <TableCell className="text-center">
                        <Input type="number" className="w-16 mx-auto" placeholder="6" />
                      </TableCell>
                      <TableCell className="text-center font-semibold">18pt</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>診察介助・処置補助（月件数）</TableCell>
                      <TableCell className="text-center">1pt/10件</TableCell>
                      <TableCell className="text-center">
                        <Input type="number" className="w-16 mx-auto" placeholder="150" />
                      </TableCell>
                      <TableCell className="text-center font-semibold">15pt</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>外来環境整備活動参加</TableCell>
                      <TableCell className="text-center">3pt/回</TableCell>
                      <TableCell className="text-center">
                    ...
                    <TableRow>
                      <TableCell>感染対策実践（手指衛生遵守率）</TableCell>
                      <TableCell className="text-center">10pt/90%以上</TableCell>
                      <TableCell className="text-center">
                        <Input type="number" className="w-16 mx-auto" placeholder="95" />%
                      </TableCell>
                    ...
                    <TableRow className="bg-gray-50">
                      ...
                      <TableCell className="text-center font-bold text-lg">149pt</TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </div>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <h4 className="font-semibold mb-3">施設内相対評価（外来准看護師間）</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div>
            ...
            <TabsContent value="corporate" className="space-y-6 mt-6">
                ...
                <Table>
                  ...
                  <TableBody>
                    ...
                    <TableRow className="bg-gray-50">
                      ...
                      <TableCell className="text-center font-bold text-lg">66pt</TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </div>
              ...
              <div className="bg-orange-50 p-4 rounded-lg">
                <h4 className="font-semibold mb-3">法人内相対評価（全准看護師間）</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div>
            ...
            <TabsContent value="summary" className="space-y-6 mt-6">
              <div>
                ...
                <div className="mt-6 space-y-4">
                  <div>
                    <Label htmlFor="next-challenges">次期の課題・目標（准看護師業務）</Label>
                    <Textarea 
                      id="next-challenges" 
                      placeholder="基本技術の向上、指示理解の改善、患者対応スキルの向上など"
                  ...
                  <div>
                    ...
                    <Textarea 
                      ...
                      placeholder="外来業務への適応状況、技術習得の進捗、今後の成長期待などを記入"
                      className="min-h-[100px]"
                    />
                  </div>
                </div>
