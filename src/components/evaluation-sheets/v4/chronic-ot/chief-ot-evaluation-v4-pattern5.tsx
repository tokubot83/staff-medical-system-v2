      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            療養型リハビリ主任作業療法士 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 療養型作業療法部門管理とリーダーシップを重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              療養型病床におけるリハビリ主任作業療法士の部門管理能力と組織への貢献を評価します。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>部門管理評価技術（チーム能力査定、施設全体評価、品質管理評価等）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>管理者治療技術（部門方針策定、困難事例統括、臨床指導、質向上推進）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>戦略的部門運営企画（年間計画策定、人材配置最適化、収益性向上、連携強化）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>組織指導・統括能力（部門統括、人事評価、研修統括、対外折衝）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、療養型病床でのリハビリ部門統括、組織運営への貢献、部門成績向上、
                      人材育成実績、対外的評価・連携実績等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="療養型病床でのリハビリ主任作業療法士として特に優れている点、部門管理能力を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="部門運営のさらなる向上のための改善点、管理者としての成長課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた部門管理目標、組織全体への貢献目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="療養型病床でのリハビリ主任作業療法士としての総合的な評価コメントを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
