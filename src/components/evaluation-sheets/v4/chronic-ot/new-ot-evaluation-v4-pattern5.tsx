      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            療養型新人作業療法士（1年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 慢性期作業療法の基礎技術習得と生活支援の実践を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              療養型病床における新人作業療法士の成長と学習を支援する評価を行います。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（ADL評価、認知機能評価、生活環境評価等）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>治療技術（維持期リハ、日常生活活動維持向上、意欲向上支援）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>長期作業療法計画立案能力（生活の質重視、意味ある活動提供）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、療養型病床での作業療法実施単位数、患者・家族満足度、チーム医療への参加、
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="療養型病床での新人作業療法士として特に優れている点、患者との関わり方で評価できる点を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる成長のために改善が必要な点、慢性期作業療法の理解を深める課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="療養型病床での作業療法業務に関する総合的な評価コメントを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
