      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            療養型中堅作業療法士（4-10年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 療養型作業療法の専門技術発揮と指導力発展を重視した評価
          </p>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              療養型病床における中堅作業療法士の専門性発揮と後輩指導を評価します。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>高度評価技術（包括的ADL評価、認知機能詳細評価、生活環境適応評価等）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>専門治療技術（維持期リハ指導、個別性重視アプローチ、複雑事例対応）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>統合的治療計画立案能力（長期目標設定、多職種連携、家族支援計画）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>高度記録・指導能力（詳細記録作成、後輩指導、研修企画参画）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、療養型病床での専門的作業療法実施、患者・家族満足度向上、チーム医療リーダーシップ、
                      後輩指導実績、研修企画参画等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="療養型病床での中堅作業療法士として特に優れている点、専門技術の発揮状況、指導力を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる専門性向上のための改善点、指導技術の向上課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた専門技術向上目標、リーダーシップ発揮目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="療養型病床での中堅作業療法士としての総合的な評価コメントを記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
