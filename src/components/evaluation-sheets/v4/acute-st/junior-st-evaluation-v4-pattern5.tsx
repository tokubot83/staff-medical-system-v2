      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            若手言語聴覚士（2-3年目） 人事評価シート v4.0
          </CardTitle>
          <p className="text-center text-gray-600 mt-2">
            パターン5改良版 - 自立した実践能力と専門性の発展を重視した評価
          </p>
        </CardHeader>
        <CardContent>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>評価技術（多様な疾患への応用、精度向上）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>コミュニケーション支援計画（自立性、創意工夫）</Label>
                        <RadioGroup 
                      ...
                      <div>
                        <Label>記録・報告書作成能力（質の向上、効率性）</Label>
                        <RadioGroup 
            ...
            <TabsContent value="contribution">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Alert>
                    <AlertDescription>
                      貢献度評価は、言語聴覚療法実施単位数、患者満足度、チーム医療への貢献、
                      カンファレンス参加度、新人指導、業務改善提案等を総合的に評価した順位です。
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="若手言語聴覚士として特に優れている点、成長が見られた点を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="improvements"
                      placeholder="さらなる成長のために改善が必要な点、今後取り組むべき課題を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="goals"
                      placeholder="次の評価期間に向けた具体的な目標、指導力向上に関する目標を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <Textarea
                      ...
                      placeholder="総合的な評価コメント、今後の期待を記入してください"
                      className="mt-2 h-32"
                    />
                  </div>
                </CardContent>
