        ...
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              ベテラン言語聴覚士の卓越した専門性と組織への戦略的貢献を評価します。
            </AlertDescription>
          </Alert>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <Label>コミュニケーション支援計画（戦略的思考、組織運営）</Label>
                        <RadioGroup 
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="ベテラン言語聴覚士として特に優れている点、組織への貢献を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
