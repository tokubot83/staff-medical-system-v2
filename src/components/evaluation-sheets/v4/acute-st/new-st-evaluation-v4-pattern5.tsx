              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="strengths"
                      placeholder="新人言語聴覚士として特に優れている点、成長が見られた点を記入してください"
                      className="mt-2 h-24"
                    />
                  </div>
